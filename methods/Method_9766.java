 ...
 */
@RequestProcessing(value="/admin/domains",method=HttpMethod.GET) @Before({StopwatchStartAdvice.class,PermissionCheck.class}) @After({PermissionGrant.class,StopwatchEndAdvice.class}) public void showDomains(final RequestContext context){
