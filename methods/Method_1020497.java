static String render(Node node){
  ...
  new AbstractVisitor(){
    @Override public boolean enterArrayAccess(    ArrayAccess arrayAccess){
    ...
    @Override public boolean enterArrayLiteral(    ArrayLiteral arrayLiteral){
      print("[");
      printSeparated(",",arrayLiteral.getValueExpressions());
      print("]");
      return false;
    }
    @Override public boolean enterAssertStatement(    AssertStatement assertStatement){
      print("assert ");
    ...
    @Override public boolean enterBinaryExpression(    BinaryExpression binaryExpression){
    ...
    @Override public boolean enterBlock(    Block block){
      print("{");
      indent();
    ...
    @Override public boolean enterBooleanLiteral(    BooleanLiteral booleanLiteral){
      print(booleanLiteral.getValue() ? "true" : "false");
      return false;
    }
    @Override public boolean enterBreakStatement(    BreakStatement breakStatement){
      print("break");
    ...
    @Override public boolean enterCatchClause(    CatchClause catchClause){
      print(" catch (");
    ...
    @Override public boolean enterCastExpression(    CastExpression castExpression){
      print(String.format("(%s) ",castExpression.getCastTypeDescriptor()));
      accept(castExpression.getExpression());
      return false;
    }
    @Override public boolean enterJsDocCastExpression(    JsDocCastExpression castExpression){
      print(String.format("/** @type {%s} */ ",castExpression.getTypeDescriptor()));
      accept(castExpression.getExpression());
      return false;
    }
    @Override public boolean enterJsDocFieldDeclaration(    JsDocFieldDeclaration fieldDeclaration){
      print(String.format("/** %s {%s} %s */ ",fieldDeclaration.isPublic() ? "@public" : "@private",fieldDeclaration.getTypeDescriptor(),fieldDeclaration.isConst() ? "@const" : ""));
      accept(fieldDeclaration.getExpression());
      return false;
    }
    @Override public boolean enterCompilationUnit(    CompilationUnit compilationUnit){
    ...
    @Override public boolean enterConditionalExpression(    ConditionalExpression conditionalExpression){
    ...
    @Override public boolean enterContinueStatement(    ContinueStatement continueStatement){
      print("continue");
    ...
    @Override public boolean enterDoWhileStatement(    DoWhileStatement doWhileStatement){
      print("do ");
    ...
    @Override public boolean enterEmptyStatement(    EmptyStatement emptyStatement){
      print(";");
      return false;
    }
    @Override public boolean enterExpression(    Expression expression){
      print("<expr>");
      return false;
    }
    @Override public boolean enterExpressionStatement(    ExpressionStatement expressionStatement){
      accept(expressionStatement.getExpression());
      print(";");
      return false;
    }
    @Override public boolean enterExpressionWithComment(    ExpressionWithComment expression){
      print("/*");
    ...
    @Override public boolean enterField(    Field field){
    ...
    @Override public boolean enterFieldAccess(    FieldAccess fieldAccess){
    ...
    @Override public boolean enterFieldDescriptor(    FieldDescriptor fieldDescriptor){
      print(fieldDescriptor.getEnclosingTypeDescriptor());
      print(".");
      print(fieldDescriptor.getName());
      return false;
    }
    @Override public boolean enterForStatement(    ForStatement forStatement){
      print("for (");
    ...
    @Override public boolean enterFunctionExpression(    FunctionExpression functionExpression){
      print("function (");
    ...
    @Override public boolean enterIfStatement(    IfStatement ifStatement){
      print("if (");
    ...
    @Override public boolean enterInstanceOfExpression(    InstanceOfExpression instanceOfExpression){
      accept(instanceOfExpression.getExpression());
      print(" instanceof ");
      print(instanceOfExpression.getTestTypeDescriptor());
      return false;
    }
    @Override public boolean enterLabeledStatement(    LabeledStatement labeledStatement){
      print(labeledStatement.getLabel());
      print(": ");
      accept(labeledStatement.getStatement());
      return false;
    }
    @Override public boolean enterInitializerBlock(    InitializerBlock initializerBlock){
    ...
    @Override public boolean enterMethod(    Method method){
    ...
    @Override public boolean enterMethodCall(    MethodCall methodCall){
    ...
    @Override public boolean enterMethodDescriptor(    MethodDescriptor methodDescriptor){
      print(methodDescriptor.getEnclosingTypeDescriptor());
      print(".");
      print(methodDescriptor.getName());
      return false;
    }
    @Override public boolean enterMultiExpression(    MultiExpression multiExpression){
      print("(");
      printSeparated(",",multiExpression.getExpressions());
      print(")");
      return false;
    }
    @Override public boolean enterNewArray(    NewArray newArray){
      print("new ");
    ...
    @Override public boolean enterNewInstance(    NewInstance newInstance){
    ...
    @Override public boolean enterNode(    Node node){
      print("<node>");
      return false;
    }
    @Override public boolean enterNullLiteral(    NullLiteral nullLiteral){
      print("null");
      return false;
    }
    @Override public boolean enterNumberLiteral(    NumberLiteral numberLiteral){
      print(numberLiteral.getValue().toString());
      return false;
    }
    @Override public boolean enterPostfixExpression(    PostfixExpression binaryExpression){
      accept(binaryExpression.getOperand());
      print(binaryExpression.getOperator().getSymbol());
      return false;
    }
    @Override public boolean enterPrefixExpression(    PrefixExpression binaryExpression){
      print(binaryExpression.getOperator().getSymbol());
      accept(binaryExpression.getOperand());
      return false;
    }
    @Override public boolean enterReturnStatement(    ReturnStatement returnStatement){
      print("return");
    ...
    @Override public boolean enterStatement(    Statement statement){
      print("<statement>");
      return false;
    }
    @Override public boolean enterStringLiteral(    StringLiteral stringLiteral){
      print(stringLiteral.getEscapedValue());
      return false;
    }
    @Override public boolean enterSuperReference(    SuperReference superReference){
      print("super");
      return false;
    }
    @Override public boolean enterSwitchCase(    SwitchCase switchCase){
    ...
    @Override public boolean enterSwitchStatement(    SwitchStatement switchStatement){
      print("switch (");
    ...
    @Override public boolean enterSynchronizedStatement(    SynchronizedStatement synchronizedStatement){
      print("synchronized (");
    ...
    @Override public boolean enterThisReference(    ThisReference thisReference){
      print(thisReference.getTypeDescriptor().getSimpleSourceName() + ".this");
      return false;
    }
    @Override public boolean enterThrowStatement(    ThrowStatement throwStatement){
      print("throw ");
      accept(throwStatement.getExpression());
      print(";");
      return false;
    }
    @Override public boolean enterTryStatement(    TryStatement tryStatement){
      print("try ");
    ...
    @Override public boolean enterType(    Type type){
    ...
    @Override public boolean enterTypeDeclaration(    TypeDeclaration typeDeclaration){
      print(typeDeclaration.getQualifiedSourceName());
      return false;
    }
    @Override public boolean enterTypeDescriptor(    TypeDescriptor typeDescriptor){
      print(typeDescriptor.getReadableDescription());
      return false;
    }
    @Override public boolean enterJavaScriptConstructorReference(    JavaScriptConstructorReference constructorReference){
      print(constructorReference.getReferencedTypeDeclaration().getQualifiedSourceName());
      return false;
    }
    @Override public boolean enterVariable(    Variable variable){
      print(variable.getTypeDescriptor());
      print(" ");
      print(variable.getName());
      return false;
    }
    @Override public boolean enterVariableDeclarationFragment(    VariableDeclarationFragment variableDeclarationFragment){
    ...
    @Override public boolean enterVariableDeclarationExpression(    VariableDeclarationExpression variableDeclarationExpression){
      String separator="";
    ...
    @Override public boolean enterVariableReference(    VariableReference variableReference){
      print(variableReference.getTarget().getName());
      return false;
    }
    @Override public boolean enterWhileStatement(    WhileStatement whileStatement){
      print("while (");
