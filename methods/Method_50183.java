@Override protected void doPost(HttpServletRequest req,HttpServletResponse resp) throws IOException {
  ...
  Instrumentation instrumentation=new ChainedInstrumentation(Arrays.asList(FuturesConverter.apiFutureInstrumentation(),GuavaListenableFutureSupport.listenableFutureInstrumentation(),new DataLoaderDispatcherInstrumentation(dataLoaderRegistry),new TracingInstrumentation()));
