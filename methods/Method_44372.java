...
assert (new String(Hex.toHexString(saltBytes)).toLowerCase() == "19457468657265756d205369676e6564204d6573736167653a0a3332");
byte[] salted=null;
...
signatureData=Sign.signMessage(salted,ecKeyPair);
