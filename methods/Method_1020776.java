/** 
 * Create an empty  {@link DispatchWorkSubject} instance with the given scheduler,capacity hint (expected number of items cached until consumption) and if an error should be delayed.
