/** 
 * @return a default ordering for all viewable ASCII characters. This list also special casesspace to be in front of the 0 and swap '.' with '/'. These special cases make typical US currency animations intuitive.
 */
