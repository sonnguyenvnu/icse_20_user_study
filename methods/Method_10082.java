...
public List<JSONObject> getTopBalanceUsers(final int fetchSize){
  ...
  final Query query=new Query().addSort(UserExt.USER_POINT,SortDirection.DESCENDING).setPage(1,fetchSize).setFilter(new PropertyFilter(UserExt.USER_JOIN_POINT_RANK,FilterOperator.EQUAL,UserExt.USER_JOIN_XXX_C_JOIN));
