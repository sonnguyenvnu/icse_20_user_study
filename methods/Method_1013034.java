public static Optional<FieldCompletion> from(final SwaggerCompletionHelper completionHelper,final CompletionResultSet completionResultSet){
 ...
 else   if (completionHelper.completeSchemaKey() || completionHelper.completeSchemaItemsKey() || completionHelper.completeDefinitionsKey() || completionHelper.completePropertiesSchemaKey() || completionHelper.completeAdditionalPropertiesKey()) {
