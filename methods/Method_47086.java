/** 
 * Convenience method to extract the remote path from the given SSH URL. For example, given <code>ssh://user:password@127.0.0.1:22/home/user/foo/bar</code>, this method returns <code>/home/user/foo/bar</code>.
