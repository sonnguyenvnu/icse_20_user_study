...
@Override public void onButtonPressed(Intent intent){
}
@Override public void onButtonPressed(Intent intent,String password) throws GeneralSecurityException, IOException {
...
@Override public void onButtonPressed(Intent intent) throws GeneralSecurityException, IOException {
...
GeneralDialogCreation.showEncryptWithPresetPasswordSaveAsDialog(context,mainActivity,PreferencesConstants.ENCRYPT_PASSWORD_MASTER,encryptIntent);
}
...
GeneralDialogCreation.showEncryptWithPresetPasswordSaveAsDialog(context,mainActivity,PreferencesConstants.ENCRYPT_PASSWORD_FINGERPRINT,encryptIntent);
}
 else {
...
@Override public void onButtonPressed(Intent intent,String password){
}
}
;
...
e.printStackTrace();
Toast.makeText(context,mainFragment.getString(R.string.crypt_encryption_fail),Toast.LENGTH_LONG).show();
}
}
 else {
