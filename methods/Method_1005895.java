@NonNull @Override public List<ViewAttribute> collect(final Switch view,AttributeTranslator attributeTranslator){
  ...
  if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
    attributes.add(new MutableBooleanViewAttribute("ShowText",view.getShowText()){
      @Override @TargetApi(Build.VERSION_CODES.LOLLIPOP) protected void mutate(      Boolean value){
