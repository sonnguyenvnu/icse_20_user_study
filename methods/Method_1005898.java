@NonNull @Override public List<ViewAttribute> collect(final ViewGroup view,AttributeTranslator attributeTranslator){
  ...
  if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
    ...
    attributes.add(new MutableBooleanViewAttribute("IsTransitionGroup",view.isTransitionGroup()){
      @Override @RequiresApi(api=Build.VERSION_CODES.LOLLIPOP) protected void mutate(      Boolean value){
