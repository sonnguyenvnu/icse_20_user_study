/** 
 * <p> Trigger the identified <code> {@link org.quartz.Job}</code> (execute it now) - with a non-volatile trigger. </p>
 */
@SuppressWarnings("deprecation") public void triggerJob(JobKey jobKey,JobDataMap data) throws SchedulerException {
  validateState();
