/** 
 * linearly interpolate for y between [x1, y1] to [x2, y2] using x y = y1 + (y2 - y1) * (x - x1) / (x2 - x1) For example:  if [x1, y1] is [0, 100], and [x2,y2] is [1, 200], then as x increases from 0 to 1, this function will increase from 100 to 200
