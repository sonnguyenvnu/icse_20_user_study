...
//archiva/archiva-modules/archiva-web/archiva-webdav/src/main/java/org/apache/archiva/webdav/ArchivaDavResource.java
    ...
    implements DavResource
{
    ...
    @Override
    public void _XXXXX_( LockManager lockManager )
    {
