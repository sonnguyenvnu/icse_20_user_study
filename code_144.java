...
//commons-dbutils/src/main/java/org/apache/commons/dbutils/handlers/properties/DatePropertyHandler.java
/*
...
public class DatePropertyHandler implements PropertyHandler {
    ...
    @Override
    public Object _XXXXX_(final Class<?> parameter, Object value) {
        final String targetType = parameter.getName();
        if ("java.sql.Date".equals(targetType)) {
