...
//eagle/eagle-core/eagle-alert-parent/eagle-alert/alert-engine/src/main/java/org/apache/eagle/alert/engine/sorter/StreamWindowRepository.java
/**
...
public class StreamWindowRepository {
    ...
    public StreamWindow _XXXXX_(long start, long end, long margin, StorageType type) {
        StreamWindow ret;
        switch (type) {
            case ONHEAP:
