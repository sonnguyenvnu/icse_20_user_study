...
//bookkeeper/stream/distributedlog/core/src/main/java/org/apache/distributedlog/ZooKeeperClientBuilder.java
/**
...
public class ZooKeeperClientBuilder {
     ...
     * @return zookeeper client builder
     */
    public synchronized ZooKeeperClientBuilder _XXXXX_(String name) {
        this.name = name;
        return this;
    }
