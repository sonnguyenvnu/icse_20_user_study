...
//bookkeeper/stream/statelib/src/main/java/org/apache/bookkeeper/statelib/impl/mvcc/MVCCStoreImpl.java
/*
...
class MVCCStoreImpl<K, V> extends RocksdbKVStore<K, V> implements MVCCStore<K, V> {
    ...
    @Override
    public RangeResult<K, V> _XXXXX_(RangeOp<K, V> rangeOp) {
        try {
