...
//archiva/archiva-modules/archiva-web/archiva-web-common/src/main/java/org/apache/archiva/web/api/DefaultJavascriptLogger.java
    ...
    implements JavascriptLogger
{
    ...
    @Override
    public Boolean _XXXXX_( JavascriptLog javascriptLog )
    {
        Logger toUse =
            javascriptLog.getLoggerName() == null ? logger : LoggerFactory.getLogger( javascriptLog.getLoggerName() );
