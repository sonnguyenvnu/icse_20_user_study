...
//eagle/eagle-security/eagle-security-common/src/main/java/org/apache/eagle/security/service/SecurityExternalMetadataResource.java
/*
...
public class SecurityExternalMetadataResource {
    ...
    @POST
    @Consumes("application/json")
    public void _XXXXX_(Collection<OozieSensitivityEntity> list){
