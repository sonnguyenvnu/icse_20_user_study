...
//bookkeeper/stream/clients/java/base/src/main/java/org/apache/bookkeeper/clients/utils/ListenableFutureRpcProcessor.java
/*
...
public abstract class ListenableFutureRpcProcessor<RequestT, ResponseT, ResultT>
     ...
     */
    @Override
    public void _XXXXX_(StorageServerChannel storageServerChannel, Throwable cause) {
        if (null != cause) {
