...
//bookkeeper/bookkeeper-server/src/main/java/org/apache/bookkeeper/client/RackawareEnsemblePlacementPolicy.java
/*
...
public class RackawareEnsemblePlacementPolicy extends RackawareEnsemblePlacementPolicyImpl
    ...
    @Override
    public DistributionSchedule.WriteSet _XXXXX_(
            List<BookieSocketAddress> ensemble,
            BookiesHealthInfo bookiesHealthInfo,
            DistributionSchedule.WriteSet writeSet) {
