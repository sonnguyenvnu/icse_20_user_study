...
//eagle/eagle-core/eagle-query/eagle-client-base/src/main/java/org/apache/eagle/service/client/impl/EagleServiceAsyncClientImpl.java
/*
...
public class EagleServiceAsyncClientImpl implements EagleServiceAsyncClient {
    ...
    @Override
    public <E extends TaggedLogAPIEntity> Future<GenericServiceAPIResponseEntity<String>> _XXXXX_(final List<E> entities, final String serviceName) throws IOException, EagleServiceClientException {
