...
public final class SpanUtils {
    ...
    /**
     * 设置行高
     * <p>当行高大于字体高度时，字体在行中的�?置由{@code align}决定</p>
     *
     * @param lineHeight 行高
     * @param align      对�?
     *                   <ul>
     *                   <li>{@link Align#ALIGN_TOP}顶部对�?</li>
     *                   <li>{@link Align#ALIGN_CENTER}居中对�?</li>
     *                   <li>{@link Align#ALIGN_BOTTOM}底部对�?</li>
     *                   </ul>
     * @return {@link SpanUtils}
     */
     ...
     *                  <li>{@link Alignment#ALIGN_OPPOSITE}相�??</li>
    ...
    /**
     * 设置模糊
     * <p>尚存bug，其他地方存在相�?�的字体的�?，相�?�字体出现在之�?的�?那么就�?会模糊，出现在之�?�的�?那会一起模糊</p>
     * <p>以上bug关闭硬件加速�?��?�</p>
     *
     * @param radius 模糊�?�径（需大于0）
     * @param style  模糊样�?<ul>
     ...
     *               <li>{@link Align#ALIGN_TOP}顶部对�?</li>
     *               <li>{@link Align#ALIGN_CENTER}居中对�?</li>
     *               <li>{@link Align#ALIGN_BASELINE}基线对�?</li>
     *               <li>{@link Align#ALIGN_BOTTOM}底部对�?</li>
     *               </ul>
     * @return {@link SpanUtils}
     */
