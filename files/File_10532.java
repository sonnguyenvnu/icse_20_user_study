...
public class ActivityLoginAct extends ActivityBase {
    ...
    private int screenHeight = 0;//�?幕高度
    private int keyHeight = 0; //软件盘弹起�?�所�?�高度
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RxBarTool.setTransparentStatusBar(this);//状�?�?�?明化
    ...
    private void initView() {
        screenHeight = this.getResources().getDisplayMetrics().heightPixels; //获�?��?幕高度
        keyHeight = screenHeight / 3;//弹起高度为�?幕高度的1/3
    }
    ...
    private void initEvent() {
        ...
        mEtPassword.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                if (!s.toString().matches("[A-Za-z0-9]+")) {
                    ...
                    Toast.makeText(mContext, "请输入数字或字�?", Toast.LENGTH_SHORT).show();
        ...
        mScrollView.addOnLayoutChangeListener(new ViewGroup.OnLayoutChangeListener() {
            ...
            public void onLayoutChange(View v, int left, int top, int right, int bottom, int oldLeft, int oldTop, int oldRight, int oldBottom) {
              /* old是改�?��?的左上�?�下�??标点值，没有old的是改�?��?�的左上�?�下�??标点值
              现在认为�?��?控件将Activity�?�上推的高度超过了1/3�?幕高，就认为软键盘弹起*/
