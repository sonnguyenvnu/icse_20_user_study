...
@Authorize(permission = "user", description = "ç”¨æˆ·ç®¡ç?†")
@Api(value = "ç”¨æˆ·ç®¡ç?†", tags = "æ?ƒé™?-ç”¨æˆ·ç®¡ç?†")
public class UserController implements
    ...
    @PutMapping(path = "/{id:.+}")
    @ApiOperation("æ ¹æ?®IDä¿®æ”¹ç”¨æˆ·ä¿¡æ?¯")
    ...
    @ApiOperation("èŽ·å?–ç”¨æˆ·çš„æ?ƒé™?ä¿¡æ?¯")
    ...
    @ApiOperation("ä¿®æ”¹å½“å‰?ç™»å½•ç”¨æˆ·çš„å¯†ç ?")
    ...
    @ApiOperation("ä¿®æ”¹æŒ‡å®šç”¨æˆ·çš„å¯†ç ?")
