...
public class UserInfoActivity extends BaseActivity implements IUserInfo, TakePhoto.TakeResultListener, InvokeListener {
    ...
    private CropOptions cropOptions;  //�?剪�?�数
    private CompressConfig compressConfig;  //压缩�?�数
    private Uri imageUri;  //图片�?存路径
    ...
    protected void initView() {
        ...
        takePhoto.onEnableCompress(compressConfig, false);//设置为需�?压缩
    }
                ...
                new MaterialDialog.Builder(this)
                        ...
                        .onPositive((dialog, which) -> {
                            ...
                            if (TextUtils.isEmpty(nickname)) {
                                ToastUtils.show("昵称�?能为空");
                                return;
                            }
                            if (TextUtils.isEmpty(brief)) {
                                ToastUtils.show("我的格言�?能为空");
                                return;
                            }
                            stopEdit();
                            dialog.dismiss();
