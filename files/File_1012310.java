...
public class SuperButton extends AppCompatButton {
    ...
    public StateListDrawable getSelector() {
        ...
        //注�?该处的顺�?，�?��?有一个状�?与之相�?，背景就会被�?�掉
        //所以�?�?把大范围放在�?�?�了，如果sd.addState(new[]{},normal)放在第一个的�?，就没有什么效果了
    ...
    /**
     * 设置背景颜色
     * 如果设定的有Orientation 就默认为是�?�?�色的Button，�?�则就是纯色的Button
     */
    ...
    private void setRadius() {
        if (shapeType == GradientDrawable.RECTANGLE) {
            if (cornersRadius != 0) {
                gradientDrawable.setCornerRadius(cornersRadius);//设置圆角的�?�径
            } else {
                //1�?2两个�?�数表示左上角，3�?4表示�?�上角，5�?6表示�?�下角，7�?8表示左下角
     ...
     * 设置�?�?��?�径
     *
     * @param gradientGradientRadius �?�?��?�径
     * @return 对象
     */
     ...
     * 设置是�?��?在 press 时改�?��?明度
     *
     * @param changeAlphaWhenPress 是�?��?在 press 时改�?��?明度
     */
    ...
    /**
     * 设置是�?��?在 disabled 时改�?��?明度
     *
     * @param changeAlphaWhenDisable 是�?��?在 disabled 时改�?��?明度
     */
