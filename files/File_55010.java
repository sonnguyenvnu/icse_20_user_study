...
public class JNINativeInterface {
     ...
     * </table>
     * 
     * <p>In most cases, programmers pass â€œ0â€? to the mode argument to ensure consistent behavior for both pinned and copied arrays. The other options give
     ...
     *
     * @return â€œ0â€? on success; returns a negative value on failure
     */
    @NativeType("jint")
