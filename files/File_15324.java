...
public class TimeUtil {
	...
	public static class Day {
		...
		public static final String NAME_THE_DAY_BEFORE_YESTERDAY = "�?天";
		...
		public static final String NAME_THE_DAY_AFTER_TOMORROW = "�?�天";
	...
	public static long getBetween(SimpleDateFormat sdf, long dateLong0, long dateLong1) {
		...
		try {
			...
			between = (date0.getTime() - date1.getTime())/1000;//除以1000是为了转�?��?秒
	...
	public static String getSmartBirthday(Date birthday) {
		...
		return getSmartBirthday(birthday.getTime(), false) + " " + (TimeUtil
				.getDateDetail(System.currentTimeMillis())[0] - birthday.getYear()) + "�?";
	}
	/**获�?�智能生日
	 * @param birthday
	 * @param needYear
