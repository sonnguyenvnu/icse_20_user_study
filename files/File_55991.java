...
public class CUDA_RESOURCE_VIEW_DESC extends Struct implements NativeResource {
    ...
    /** Returns a new {@code CUDA_RESOURCE_VIEW_DESC} instance allocated on the thread-local {@link MemoryStack}. */
    public static CUDA_RESOURCE_VIEW_DESC mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code CUDA_RESOURCE_VIEW_DESC} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    ...
    /**
     * Returns a new {@link CUDA_RESOURCE_VIEW_DESC.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static CUDA_RESOURCE_VIEW_DESC.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link CUDA_RESOURCE_VIEW_DESC.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static CUDA_RESOURCE_VIEW_DESC.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static CUDA_RESOURCE_VIEW_DESC.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static CUDA_RESOURCE_VIEW_DESC.Buffer callocStack(int capacity, MemoryStack stack) {
