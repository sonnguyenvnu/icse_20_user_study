...
public class DubboSpringCloudConsumerBootstrap {
    ...
    private void callParams() {
        ...
        // RestTemplate call
        System.out.println(restTemplate.getForEntity("http://" + providerApplicationName + "/param?param=�?马哥", String.class));
    }
...
//         Spring Cloud Open Feign REST Call
        ...
        // RestTemplate call
        System.out.println(restTemplate.postForObject("http://" + providerApplicationName + "/request/body/map?param=�?马哥", data, User.class));
    }
