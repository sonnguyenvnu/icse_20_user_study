...
public class InviteFriendActivity extends WfcBaseActivity {
    ...
    protected void afterViews() {
        ...
        introTextView.setText("æˆ‘æ˜¯ " + (me == null ? "" : me.displayName));
    }
        ...
        contactViewModel.invite(userInfo.uid, introTextView.getText().toString())
                .observe(this, new Observer<Boolean>() {
                    ...
                    public void onChanged(@Nullable Boolean aBoolean) {
                        if (aBoolean) {
                            Toast.makeText(InviteFriendActivity.this, "å¥½å?‹é‚€è¯·å·²å?‘é€?", Toast.LENGTH_SHORT).show();
                            finish();
                        } else {
                            Toast.makeText(InviteFriendActivity.this, "æ·»åŠ å¥½å?‹å¤±è´¥", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
