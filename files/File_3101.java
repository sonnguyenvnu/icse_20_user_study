 ...
 *
 * <copyright file="PinyinUtil.java" company="上海林原信�?�科技有�?公�?�">
...
public class PinyinUtil
{
    ...
    public static String convertToneNumber2ToneMark(final String pinyinStr)
    {
        ...
        if (lowerCasePinyinStr.matches("[a-z]*[1-5]?"))
        {
            ...
            final String allMarkedVowelStr = "�?áǎàaēéěèeīí�?ìi�?óǒòoūúǔùuǖǘǚǜü";
    ...
    /**
     * 转�?�List<Pinyin> pinyinList到List<String>，其中的String为带声调符�?�形�?
     * @param pinyinList
     * @return
     */
