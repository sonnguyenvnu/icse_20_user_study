...
public class JSONRequest extends JSONObject {
	...
	public static final String KEY_TAG = "tag";//�?�在最外层，最外层用JSONRequest
	public static final String KEY_VERSION = "version";//�?�在最外层，最外层用JSONRequest
	public static final String KEY_FORMAT = "format";//�?�在最外层，最外层用JSONRequest
