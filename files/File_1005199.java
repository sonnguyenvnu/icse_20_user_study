...
public class SelectZTreeTag extends TagSupport {
	...
	private String id;
	private String url;
	private String windowWidth; //窗�?�宽度
	private String windowHeight; //窗�?�高度

	private boolean selectCascadeParent = false;	//勾选时选择父节点
	private boolean selectCascadeChildren = false;	//勾选时选择�?节点
	private boolean cancelCascadeParent = false;	//�?�消勾选时选择父节点
	private boolean cancelCascadeChildren = false;	//�?�消勾选时选择�?节点
