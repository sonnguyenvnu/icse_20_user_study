 ...
 *
 * <copyright file="NeuralNetworkParser.java" company="�?农场">
...
public class NeuralNetworkParser implements ICacheAble
{
    ...
    /**
     * 指定使用�?离特�?，具体�?�考Zhang and Nivre (2011)
     */
    boolean use_distance;
    /**
     * 指定使用valency特�?，具体�?�考Zhang and Nivre (2011)
     */
    boolean use_valency;
    /**
     * 指定使用�?�?�类特�?，具体�?�考Guo et. al, (2015)
     */
    boolean use_cluster;
    ...
    public boolean loadTxt(String path)
    {
        ...
        assert !lineIterator.hasNext() : "文件有残留，�?�能是读�?�逻辑�?对";
    ...
    public boolean load(ByteArray byteArray)
    {
        ...
        assert !byteArray.hasMore() : "文件有残留，�?�能是读�?�逻辑�?对";
     ...
     * 将实例转为�?存树
     * @param data 实例
     * @param dependency 输出的�?存树
     * @param with_dependencies 是�?�输出�?存关系（仅在解�?�?��?有�?义）
     */
     ...
     * �?存分�?
     * @param data 实例
     * @param heads �?存指�?�的储存�?置
     * @param deprels �?存关系的储存�?置
     */
...
//        deprels.resize(L);
     ...
     * 获�?�(S0和S1的)�?价特�?
     * @param ctx 上下文
     * @param nr_left_children 左孩�?数�?列表
     * @param nr_right_children �?�孩�?数�?列表
     * @param features 输出特�?
     */
