...
public class StringUtils {
    ...
    /**
     * <p>�?�得第一个出现的分隔�?串之�?�的�?串。
     * 如果字符串为<code>null</code>，则返回<code>null</code>。 如果分隔�?串为<code>null</code>或未找到该�?串，则返回原字符串。
     * </p>
     * <pre>
     ...
     *
     * @param str       字符串
     * @param separator �?�?�索的分隔�?串
     * @return �?串，如果原始串为<code>null</code>，则返回<code>null</code>
     */
