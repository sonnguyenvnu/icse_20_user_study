 ...
 *         15/11/17 扩展功能，添加对文件的支�?
 *         15/11/18 扩展功能，增加对XML的支�?，修�?BUG
 *         15/12/8  扩展功能，添加对任�?�?�数的支�?
 *         15/12/11 扩展功能，增加对无�?长字符串支�?
 *         16/6/13  扩展功能，添加对自定义全局Tag的支�?,修�?内部类�?能点击跳转的BUG
 *         16/6/15  扩展功能，添加�?能关闭的KLog.debug(),用于�?�布版本的Log打�?�,优化部分代�?
