...
/** 没有继承HorizontalScrollView�?能滑动,对于ViewPager无�?赖 */
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    public CommonTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        setWillNotDraw(false);//�?写onDraw方法,需�?调用这个方法�?�清除flag
...
//        Log.d("AAA", "mCurrentP--->" + mCurrentP.left + "&" + mCurrentP.right);
    ...
    private void calcIndicatorRect() {
        ...
        if (mIndicatorWidth < 0) {   //indicatorWidth�?于0时,原jpardogo's PagerSlidingTabStrip

        } else {//indicatorWidth大于0时,圆角矩形以�?�三角形
     ...
     * 显示未读消�?�
     *
     * @param position 显示tab�?置
     * @param num      num�?于等于0显示红点,num大于0显示数字
     */
    ...
    /**
     * 设置�??示红点�??移,注�?
     * 1.控件为固定高度:�?�照点为tab内容的�?�上角
     * 2.控件高度�?固定(WRAP_CONTENT):�?�照点为tab内容的�?�上角,此时高度已是红点的最高显示范围,所以这时bottomPadding其实就是topPadding
     */
    ...
    /** 当�?类�?��??供了少许设置未读消�?�属性的方法,�?�以通过该方法获�?�MsgView对象从而�?��?设置 */
