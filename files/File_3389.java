 ...
 * <create-date>2017-10-26 下�?�9:21</create-date>
 *
 * <copyright file="CWSInstance.java" company="�?农场">
...
public class CWSInstance extends Instance
{
    ...
    public CWSInstance(String[] termArray, FeatureMap featureMap)
    {
        ...
        {
            assert termArray[i].length() > 0 : "�?��?中出现了长度为0的�?��?，�?�?�法：" + sentence;
...
//
//        addFeature("BL=" + preLabel, featureVec, featureMap);    // 虽然有preLabel，但并没有加上当�?label，当�?label是由调用者自行加的
