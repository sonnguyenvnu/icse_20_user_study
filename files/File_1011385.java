...
@Generated
public class Template_reduce_GetAncestor_noConceptList_SameML extends TemplateDeclarationBase implements TemplateDeclaration2 {

  public Template_reduce_GetAncestor_noConceptList_SameML() {
  }

  public SNodeReference getTemplateNode() {
    return new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "1627366655853340206");
  }
  ...
  protected FragmentResult applyPart0(@NotNull final TemplateContext context) throws GenerationException {
    ...
    try {
      ...
      tnode1.setReference(myAssociationLinks[1], SReference.create(myAssociationLinks[1], tnode1, PersistenceFacade.getInstance().createModelReference("r:c3548bac-30eb-4a2a-937c-0111d5697309(jetbrains.mps.lang.smodel.generator.smodelAdapter)"), PersistenceFacade.getInstance().createNodeId("6599163591527293260")));
      TemplateContext context1 = context.subContext();
      {
        Collection<SNode> tlist2 = null;
        final SNode copySrcInput2 = QueriesGenerated.sourceNodeQuery_53_0(new SourceSubstituteMacroNodeContext(context1, copySrcMacro_tbyes_b0a0c0d0c0g));
        tlist2 = environment.copyNodes(TemplateUtil.singletonList(copySrcInput2), copySrcMacro_tbyes_b0a0c0d0c0g, "tpl/r:00000000-0000-4000-0000-011c89590303/1627366655853340208", context1);
      ...
      }
      {
        ...
        try {
          SNodeAccessUtil.setProperty(tnode6, myProperties[0], TemplateUtil.asString(QueriesGenerated.propertyMacro_GetValue_53_0(new PropertyMacroContext(context1, null, propertyMacro_tbyes_c0a0c0a0b0f0c0g))));
        } finally {
        }
      ...
      }
      {
        ...
        try {
          SNodeAccessUtil.setProperty(tnode7, myProperties[0], TemplateUtil.asString(QueriesGenerated.propertyMacro_GetValue_53_1(new PropertyMacroContext(context1, null, propertyMacro_tbyes_c0a0c0a0b0g0c0g))));
        } finally {
        }
      ...
      }
      {
        ...
        try {
          SNodeAccessUtil.setProperty(tnode8, myProperties[0], "true");
        } finally {
        }
  ...
  private static SNodePointer copySrcMacro_tbyes_b0a0c0d0c0g = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "1627366655853340209");
  private static SNodePointer propertyMacro_tbyes_c0a0c0a0b0f0c0g = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "1627366655853340219");
  private static SNodePointer propertyMacro_tbyes_c0a0c0a0b0g0c0g = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "1627366655853340228");
}
