 ...
 * 
 * <p>
 * 如果分片�?能整除, 则�?能整除的多余分片将�?次追加到�?�?��?的�?务器.
 * 如: 
 * 1. 如果有3�?��?务器, 分�?9片, 则�?�?��?务器分到的分片是: 1=[0,1,2], 2=[3,4,5], 3=[6,7,8].
 * 2. 如果有3�?��?务器, 分�?8片, 则�?�?��?务器分到的分片是: 1=[0,1,6], 2=[2,3,7], 3=[4,5].
 * 3. 如果有3�?��?务器, 分�?10片, 则�?�?��?务器分到的分片是: 1=[0,1,2,9], 2=[3,4,5], 3=[6,7,8].
 * </p>
 * 
 * @author zhangliang
 */
