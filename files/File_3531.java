...
/**
 * 使用AhoCorasickDoubleArrayTrie实现的最长分�?器<br>
 * 需�?用户调用setTrie()�??供一个AhoCorasickDoubleArrayTrie
 *
 * @author hankcs
 */
public class AhoCorasickDoubleArrayTrieSegment extends DictionaryBasedSegment
{
    ...
    {
        throw new UnsupportedOperationException("AhoCorasickDoubleArrayTrieSegment暂时�?支�?用户�?典。");
    }
