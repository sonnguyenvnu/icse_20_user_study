 ...
 * Guice is the â€œofficialâ€? solution.
 * </p>
 ...
 *         // or to create objects that are bound â€œjust-in-timeâ€?.
 ...
 * This registry is able to retrieve objects that were explicitly bound (i.e. defined by a module), and bind objects â€œjust in timeâ€?.
 ...
 * </p>
 * <p>
 * However, this will not create â€œjust-in-timeâ€? bindings. Only objects that were explicitly bound can be retrieved this way.
 * </p>
 * <h3>Guice modules as Ratpack â€œpluginsâ€?.</h3>
 * <p>
 ...
 * <p>
 * The Ratpack Groovy add-on provides application modes that automatically incorporate Guice (namely the â€œRatpack Scriptâ€? mode).
...
public abstract class Guice {
  ...
  /**
   * Creates a Ratpack {@link Registry} backed by the given {@link Injector} that will <b>NOT</b> create objects via â€œjust-in-timeâ€? binding.
   *
