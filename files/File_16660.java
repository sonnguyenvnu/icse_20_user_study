...
@Authorize(permission = "district", description = "行政区划管�?�")
@Api(value = "行政区划管�?�", tags = "组织架构-行政区划管�?�")
