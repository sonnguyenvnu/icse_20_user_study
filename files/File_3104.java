 ...
 *
 * <copyright file="PinyinGuesser.java" company="上海林原信�?�科技有�?公�?�">
...
public class String2PinyinConverter
{
    ...
    /**
     * 将音调统一�?�为轻声，下标为拼音的ordinal，值为音调5或最大值
     */
    ...
    /**
     * 将拼音文本转化为完整的拼音，支�?汉英混�?�的�?�乱文本，注�?如果混用拼音和输入法头的�?，并�?会有多高的准确率，声调也�?会准的
     * @param complexText
     * @return
     */
...
//        System.out.println(tokenize);
    ...
    /**
     * 将混�?�文本转为拼音
     * @param complexText 混�?�汉字�?拼音�?输入法头的文本，比如“飞�?zh下sqianch�?
     * @param removeTone
