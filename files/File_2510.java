 ...
 *
 * <copyright file="DartMap.java" company="ä¸Šæµ·æž—åŽŸä¿¡æ?¯ç§‘æŠ€æœ‰é™?å…¬å?¸">
...
/**
 * å?Œæ•°ç»„trieæ ‘mapï¼Œæ›´çœ?å†…å­˜ï¼ŒåŽŸæœ¬å¸Œæœ›ä»£æ›¿DoubleArrayTrieï¼Œå?Žæ?¥å?‘çŽ°æ•ˆçŽ‡ä¸?å¤Ÿ
 * @author hankcs
 */
public class DartMap<V> extends DoubleArray implements Map<String, V>, ITrie<V>
{
    ...
    {
        throw new UnsupportedOperationException("å?Œæ•°ç»„ä¸?æ”¯æŒ?å¢žé‡?å¼?æ?’å…¥");
    }

    @Override
    public V remove(Object key)
    {
        throw new UnsupportedOperationException("å?Œæ•°ç»„ä¸?æ”¯æŒ?åˆ é™¤");
    }
    ...
    public void clear()
    {
        throw new UnsupportedOperationException("å?Œæ•°ç»„ä¸?æ”¯æŒ?");
    }
