...
public class TenantController extends BladeController {
	...
	@GetMapping("/list")
	@ApiImplicitParams({
		@ApiImplicitParam(name = "tenantCode", value = "�?�数�??称", paramType = "query", dataType = "string"),
		@ApiImplicitParam(name = "tenantName", value = "角色别�??", paramType = "query", dataType = "string"),
		@ApiImplicitParam(name = "contactNumber", value = "�?�系电�?", paramType = "query", dataType = "string")
	})
	 ...
	 */
	@GetMapping("/select")
	@ApiOperation(value = "下拉数�?��?", notes = "传入tenant")
