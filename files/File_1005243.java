 ...
 * @author liuht
 */
@Api(value="userRest",description="用户信�?�管�?�",tags="UserRestController")
@Controller
...
public class UserRestController {
	...
	/**
	 * 访问地�?�：http://localhost:8080/jeecg/rest/user
	 * @return
	 */
	@RequestMapping(method = RequestMethod.GET)
	@ResponseBody
	@ApiOperation(value="用户列表信�?�",produces="application/json",httpMethod="GET")
	...
	/**
	 * 访问地�?�：http://localhost:8080/jeecg/rest/user/{id}
	 * @param id
	 * @return
	 */
	@RequestMapping(value = "/{id}", method = RequestMethod.GET)
	@ResponseBody
	@ApiOperation(value="根�?�ID获�?�用户信�?�",notes="根�?�ID获�?�用户信�?�",httpMethod="GET",produces="application/json")
