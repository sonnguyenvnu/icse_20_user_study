 ...
 *
 * <copyright file="SynonymHelper.java" company="ä¸Šæµ·æž—åŽŸä¿¡æ?¯ç§‘æŠ€æœ‰é™?å…¬å?¸">
...
{
    /**
     * å?Œä¸€è¡Œæœ€å¤šæ”¯æŒ?ç¼–ç ?è¿™ä¹ˆå¤šä¸ªå?•è¯?
     */
    public static final long MAX_WORDS = 999L;
    /**
     * å°¾æ•°çš„é•¿åº¦ï¼Œè¡¨ç¤ºåŽŸå­?è¯?çš„index
     */
    ...
    public static long convertString2Id(String idString)
    {
        ...
        id =    (idString.charAt(0) - 'A') * 26L * 10 * 10 * 26 * 10 * 10 +
                ...
                (idString.charAt(6) - '0') ;    // ç¼–ç ?ç­‰å?·å‰?é?¢çš„
        return id;
    }
