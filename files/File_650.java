...
public class JodaCodec implements ObjectSerializer, ContextObjectSerializer, ObjectDeserializer {
    ...
    private final static DateTimeFormatter formatter_dt19_kr   = DateTimeFormat.forPattern("yyyy년M월d�?� HH:mm:ss");
    ...
    private final static DateTimeFormatter formatter_d10_kr    = DateTimeFormat.forPattern("yyyy년M월d�?�");
