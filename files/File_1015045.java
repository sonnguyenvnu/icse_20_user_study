...
public class UserInfoFragment extends Fragment {
    ...
    private void setUserInfo(UserInfo userInfo) {
        ...
        if (ChatManager.Instance().isMyFriend(userInfo.uid)) {
            mobileTextView.setText("电�?:" + userInfo.mobile);
        ...
        if (requestCode == REQUEST_CODE_PICK_IMAGE && resultCode == Activity.RESULT_OK) {
            ...
            result.observe(this, booleanOperateResult -> {
                if (booleanOperateResult.isSuccess()) {
                    Toast.makeText(getActivity(), "更新头�?�?功", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(getActivity(), "更新头�?失败: " + booleanOperateResult.getErrorCode(), Toast.LENGTH_SHORT).show();
                }
            });
        } else {
    ...
    void showMyQRCode() {
        ...
        startActivity(QRCodeActivity.buildQRCodeIntent(getActivity(), "二维�?", userInfo.portrait, qrCodeValue));
    }
}
