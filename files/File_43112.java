...
public class BitfinexAccountService extends BitfinexAccountServiceRaw implements AccountService {
  ...
  public String withdrawFunds(Currency currency, BigDecimal amount, String address)
    ...
    try {
      ...
      // The wallet to withdraw from, can be â€œtradingâ€?, â€œexchangeâ€?, or â€œdepositâ€?.
      String walletSelected = "exchange";
      // We have to convert XChange currencies to Bitfinex currencies: can be â€œbitcoinâ€?, â€œlitecoinâ€?
      // or
      // â€œetherâ€? or â€œtetherâ€? or â€œwireâ€?.
