...
//      }
      ...
      try {
        ...
        version = getVersion();
        System.err.println("The version number for â€œ" + name + "â€? is not a number.");
...
//        System.err.println("The last updated date for the â€œ" + name
//                           + "â€? contribution is not set properly.");
//        System.err
...
//        System.err.println("The minimum compatible revision for the â€œ" + name
//          + "â€? contribution is not set properly. Assuming minimum revision 0.");
      }
...
//        System.err.println("The maximum compatible revision for the â€œ" + name
//                           + "â€? contribution is not set properly. Assuming maximum revision INF.");
      }
