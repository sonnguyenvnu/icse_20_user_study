...
@Generated
public class Template_reduce_GetDescendants_whereConceptInList extends TemplateDeclarationBase implements TemplateDeclaration2 {
  ...
  protected FragmentResult applyPart0(@NotNull final TemplateContext context) throws GenerationException {
    ...
    try {
      ...
      tnode1.setReference(myAssociationLinks[1], SReference.create(myAssociationLinks[1], tnode1, PersistenceFacade.getInstance().createModelReference("r:c3548bac-30eb-4a2a-937c-0111d5697309(jetbrains.mps.lang.smodel.generator.smodelAdapter)"), PersistenceFacade.getInstance().createNodeId("6599163591527293848")));
      ...
      }
      {
        ...
        try {
          SNodeAccessUtil.setProperty(tnode10, myProperties[0], TemplateUtil.asString(QueriesGenerated.propertyMacro_GetValue_35_0(new PropertyMacroContext(context1, null, propertyMacro_z3mp7r_c0a0c0a0b0f0c0g))));
        } finally {
        }
          ...
          TemplateContext context6 = context1.subContext();
          {
            ...
            try {
              TemplateContext context7 = context6.subContext();
              {
                ...
                try {
                  tnode13.setReference(myAssociationLinks[2], SReference.create(myAssociationLinks[2], tnode13, PersistenceFacade.getInstance().createModelReference("8865b7a8-5271-43d3-884c-6fd1d9cfdd34/java:org.jetbrains.mps.openapi.language(MPS.OpenAPI/)"), PersistenceFacade.getInstance().createNodeId("~SAbstractConcept")));
                } finally {
                }
              ...
              }
              {
                ...
                for (SNode child16 : TemplateUtil.asNotNull(tlist14)) {
                  tnode12.addChild(myAggregationLinks[2], child16);
                }
                // TODO validate child 
              }
            } finally {
  ...
  private static SNodePointer copySrcMacro_z3mp7r_b0a0c0d0c0g = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "1173119356574");
  private static SNodePointer loopMacroRef_z3mp7r_b0a0a1a2a1a1a1a4a2a6 = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "3902354333654138603");
  private static SNodePointer callMacro_z3mp7r_b0a0a3a2a2a1a1a1a4a2a6 = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "633481135935145298");
  private static SNodePointer propertyMacro_z3mp7r_c0a0c0a0b0f0c0g = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "1176946990348");
  private static SNodePointer loopMacroRef_z3mp7r_b0a0a1a2a1a1a1a6a2a6 = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "3902354333654144729");
  private static SNodePointer callMacro_z3mp7r_b0a0a3a2a2a1a1a1a6a2a6 = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "633481135935145299");
}
