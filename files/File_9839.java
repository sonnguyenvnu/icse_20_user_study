...
public class SettingsProcessor {
    ...
    public void showSettings(final RequestContext context) {
        ...
        // “感谢加入�?系统通知已读置�? https://github.com/b3log/symphony/issues/907
    ...
    public void pointBuy(final RequestContext context) {
        ...
        // 故�?先生�?�?�返回校验，所以�?�使积分�?够也是�?�以兑�?��?功的
        // 这是为了让积分�?够的用户�?�以通过这个�?�门兑�?��?分�?�邀请�?以实现积分“自充�?
        // �?�期�?�能会关掉这个�?特性】
    ...
    private static final String[][] emojiLists = {{
            ...
            "eggplant",
            "tomato",
            Emotion.EOF_EMOJI // 标记结�?�以便在function.ftl中处�?�
    }};
}
