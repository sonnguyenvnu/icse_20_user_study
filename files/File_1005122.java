 ...
 *
 */
@Api(value="JformOrderMain2",description="è®¢å?•ä¸»ä¿¡æ?¯",tags="jformOrderMain2Controller")
@Controller
...
public class JformOrderMain2Controller extends BaseController {
	...
	/**
	 * è®¢å?•ä¸»ä¿¡æ?¯æ–°å¢žç¼–è¾‘å­—æ®µé¡µé?¢è·³è½¬
	 * 
	 * @return
	 */
	...
	*/
	...
	@ResponseBody
	@ApiOperation(value="è®¢å?•ä¸»ä¿¡æ?¯åˆ—è¡¨ä¿¡æ?¯",produces="application/json",httpMethod="GET")
	...
	@ResponseBody
	@ApiOperation(value="æ ¹æ?®IDèŽ·å?–è®¢å?•ä¸»ä¿¡æ?¯ä¿¡æ?¯",notes="æ ¹æ?®IDèŽ·å?–è®¢å?•ä¸»ä¿¡æ?¯ä¿¡æ?¯",httpMethod="GET",produces="application/json")
	public ResponseMessage<?> get(@ApiParam(required=true,name="id",value="ID")@PathVariable("id") String id) {
		JformOrderMain2Entity task = jformOrderMain2Service.get(JformOrderMain2Entity.class, id);
		if (task == null) {
			return Result.error("æ ¹æ?®IDèŽ·å?–è®¢å?•ä¸»ä¿¡æ?¯ä¿¡æ?¯ä¸ºç©º");
		}
		JformOrderMain2Page page = new JformOrderMain2Page();
		try {
	...
	@ResponseBody
	@ApiOperation(value="åˆ›å»ºè®¢å?•ä¸»ä¿¡æ?¯")
	public ResponseMessage<?> create(@ApiParam(name="è®¢å?•ä¸»ä¿¡æ?¯å¯¹è±¡")@RequestBody JformOrderMain2Page jformOrderMain2Page, UriComponentsBuilder uriBuilder) {
		...
		try{
            ...
            logger.info(e.getMessage());
            return Result.error("ä¿?å­˜è®¢å?•ä¸»ä¿¡æ?¯å¤±è´¥");
        }
		jformOrderMain2Service.addMain(jformOrderMain2, jformOrderTicket2List,jformOrderCustomer2List);
	...
	@ResponseBody
	@ApiOperation(value="æ›´æ–°è®¢å?•ä¸»ä¿¡æ?¯",notes="æ›´æ–°è®¢å?•ä¸»ä¿¡æ?¯")
	public ResponseMessage<?> update(@RequestBody JformOrderMain2Page jformOrderMain2Page) {
		...
		try{
            ...
            logger.info(e.getMessage());
            return Result.error("è®¢å?•ä¸»ä¿¡æ?¯æ›´æ–°å¤±è´¥");
        }
		jformOrderMain2Service.updateMain(jformOrderMain2, jformOrderTicket2List,jformOrderCustomer2List);
	...
	@ApiOperation(value="åˆ é™¤è®¢å?•ä¸»ä¿¡æ?¯")
	public ResponseMessage<?> delete(@ApiParam(name="id",value="ID",required=true)@PathVariable("id") String id) {
		...
		try {
			...
			e.printStackTrace();
			return Result.error("è®¢å?•ä¸»ä¿¡æ?¯åˆ é™¤å¤±è´¥");
		}
