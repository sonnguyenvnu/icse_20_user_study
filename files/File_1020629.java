...
//    private Object obj = new Object();
    ...
    public FastConnectionPool(long minPoolSize, long maxPoolSize, long waitTimes) {
        System.out.println(
            "[线程池构造方法(ConnectionPool)][默认�?�数：minPoolSize=" + minPoolSize + ",maxPoolSize=" + maxPoolSize + ",waitTimes="
                + waitTimes + "]");
    ...
    private void poolInit() {
        try {
            ...
            while (trackerServer == null && flag < 5) {
                System.out.println("[创建TrackerServer(createTrackerServer)][第" + flag + "次�?建]");
                flag++;
                initClientGlobal();
                trackerServer = trackerClient.getConnection();
            }
    ...
    public void checkin(StorageClient1 client1) {
        ...
        System.out.println("[释放当�?连接(checkin)]");
