...
public class CodeController extends BladeController {
	...
	@GetMapping("/list")
	@ApiImplicitParams({
		@ApiImplicitParam(name = "codeName", value = "模�?��??", paramType = "query", dataType = "string"),
		@ApiImplicitParam(name = "tableName", value = "表�??", paramType = "query", dataType = "string"),
		@ApiImplicitParam(name = "modelName", value = "实体�??", paramType = "query", dataType = "string")
	})
	...
	@ApiOperation(value = "代�?生�?", notes = "传入ids")
	public R genCode(@ApiParam(value = "主键集�?�", required = true) @RequestParam String ids, @RequestParam(defaultValue = "sword") String system) {
