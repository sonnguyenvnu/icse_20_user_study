...
public class EmojiParser {
   ...
   * will be deleted.<br>
   * Example: <code>ðŸ‘¦ðŸ?¿</code> will be replaced by <code>:boy:</code><br>
   * <br>
   * When a fitzpatrick modifier is present with a IGNORE action, the modifier
   * will be ignored.<br>
   * Example: <code>ðŸ‘¦ðŸ?¿</code> will be replaced by <code>:boy:ðŸ?¿</code><br>
   *
   * @param input             the string to parse
   ...
   * Examples:<br>
   * <code>:smile:</code> will be replaced by <code>ðŸ˜„</code><br>
   * <code>&amp;#128516;</code> will be replaced by <code>ðŸ˜„</code><br>
   * <code>:boy|type_6:</code> will be replaced by <code>ðŸ‘¦ðŸ?¿</code>
   *
   * @param input the string to parse
   *
   ...
   * Example: <code>ðŸ˜„</code> will be replaced by <code>&amp;#128516;</code><br>
   * <br>
