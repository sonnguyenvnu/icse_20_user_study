...
public class TreeSelectTag extends TagSupport {
	...
	private String divClass;//默认的class�??称
	private String inputClass;//input输入框对应的样�?
	
	private boolean multiCheck = true;//是�?��?�以多选
	
	private String code;
	
	private String formStyle;//表�?�风格 ace default
	...
	private void textInput(StringBuffer resultSb) {
		...
		if(StringUtil.isEmpty(field)){
			throw new BusinessException("field字段�?能为空");
		}
