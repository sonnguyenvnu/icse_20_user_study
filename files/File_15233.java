 ...
 * @author Lemon
 * @use
 * <br> toActivityæˆ–startActivityForResult (TopMenuWindow.createIntent(...), requestCode);
 * <br> ç„¶å?Žåœ¨onActivityResultæ–¹æ³•å†…
 * <br> data.getIntExtra(TopMenuWindow.RESULT_POSITION); å?¯å¾—åˆ°ç‚¹å‡»çš„ position
 * <br> æˆ–
 * <br> data.getIntExtra(TopMenuWindow.RESULT_INTENT_CODE); å?¯å¾—åˆ°ç‚¹å‡»çš„ intentCode
 */
