...
public class ParamController extends BladeController {
	...
	@GetMapping("/list")
	@ApiImplicitParams({
		@ApiImplicitParam(name = "paramName", value = "�?�数�??称", paramType = "query", dataType = "string"),
		@ApiImplicitParam(name = "paramKey", value = "�?�数键�??", paramType = "query", dataType = "string"),
		@ApiImplicitParam(name = "paramValue", value = "�?�数键值", paramType = "query", dataType = "string")
	})
