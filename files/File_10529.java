 ...
 * @author vondear
 */
public class ActivityLocation extends ActivityBase implements LocationListener {//原生的定�? 需�?手机设备GPS 很好
    ...
    private void gpsCheck() {
        if (!RxLocationTool.isGpsEnabled(this)) {
            ...
            MaterialDialog materialDialog = builder.title("GPS未打开").content("您需�?在系统设置中打开GPS方�?�采集数�?�").positiveText("去设置")
    ...
    public void onLocationChanged(Location location) {
        mTvAboutLocation.setText("�?度: " + RxLocationTool.gpsToDegree(location.getLongitude()) +
                "\n纬度: " + RxLocationTool.gpsToDegree(location.getLatitude()) +
                "\n精度: " + location.getAccuracy() +
                "\n海拔: " + location.getAltitude() +
                "\n方�?: " + location.getBearing() +
