...
public class AboutActivity extends WfcBaseActivity {
    ...
    public void intro() {
        WfcWebViewActivity.loadUrl(this, "é‡Žç?«IMåŠŸèƒ½ä»‹ç»?", "http://docs.wildfirechat.cn/");
    }

    @OnClick(R.id.agreementOptionItemView)
    public void agreement() {
        WfcWebViewActivity.loadUrl(this, "é‡Žç?«IMç”¨æˆ·å??è®®", "http://www.wildfirechat.cn/firechat_user_agreement.html");
    }

    @OnClick(R.id.privacyOptionItemView)
    public void privacy() {
        WfcWebViewActivity.loadUrl(this, "é‡Žç?«IMä¸ªäººä¿¡æ?¯ä¿?æŠ¤æ”¿ç­–", "http://www.wildfirechat.cn/firechat_user_privacy.html");
    }
}
