 ...
 *
 * <copyright file="Utility.java" company="�?农场">
...
public class Utility
{
    ...
    /**
     * 将人民日报格�?的分�?语料转化为空格分割的语料
     *
     * @param inputFolder 输入人民日报语料的上级目录(该目录下的所有文件都是一篇人民日报分�?文章)
     * @param outputFile  输出一整个CRF训练格�?的语料
     * @param begin       �?�多少个文档之�?�
     * @param end
     * @throws IOException 转�?�过程中的IO异常
     */
    ...
    public static Map<String, double[]> evaluateNER(NERecognizer recognizer, String goldFile)
    {
        ...
        for (double[] s : scores.values())
        {
            ...
            s[1] = s[2] / s[1] * 100; // R=正确识别该类命�??实体数/该类命�??实体总数×100%
            s[0] = s[2] / s[0] * 100; // P=正确识别该类命�??实体数/识别出该类命�??实体总数×100%
