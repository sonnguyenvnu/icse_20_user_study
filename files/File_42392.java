...
public class DateUtils extends org.apache.commons.lang.time.DateUtils {
	 ...
	 *            日期2
	 * @param withUnit
	 *            �?��?字段，从Calendar field�?�值
	 * @return 等于返回0值, 大于返回大于0的值 �?于返回�?于0的值
	 */
	public static int compareDate(Date date, Date otherDate, int withUnit) {
		...
		case Calendar.MILLISECOND:
			break;
		default:
			throw new IllegalArgumentException("withUnit �?��?字段 " + withUnit + " �?�?�法�?�?");
		}
	 ...
	 * �?�得两个日期之间的日数
	 * 
	 * @return t1到t2间的日数，如果t2 在 t1之�?�，返回正数，�?�则返回负数
	 */
	...
	/**
	 * 利用缺�?的Date格�?(YYYY/MM/DD)转�?�String到java.sql.Timestamp
	 *
	 * @param sDate
	 *            Date string
	 * @return
	...
	/**
	 * 利用缺�?的Date格�?(YYYY/MM/DD hh:mm:ss)转化String到java.sql.Timestamp
	 *
	 * @param sDate
	 *            Date string
	 * @param sFmt
	...
	public static Timestamp toSqlTimestamp(String sDate, String sFmt) {
		...
		// java.sql.Timestamp.value() �?求的格�?必须为yyyy-mm-dd hh:mm:ss.fffffffff
		return Timestamp.valueOf(temp);
	}

	/**
	 * 以YYYY/MM/DD HH24:MI:SS格�?返回系统日期时间
	 *
	 * @return 系统日期时间
	 * @since 1.0
	 * @history
	...
	/**
	 * 根�?�指定的Format转化java.util.Date到String
	 *
	 * @param dt
	...
	/**
	 * 利用指定SimpleDateFormat instance转�?�java.util.Date到String
	 *
	 * @param dt
	 *            java.util.Date instance
	 * @param formatter
	...
	/**
	 * 转�?�java.sql.Timestamp到String，格�?为YYYY/MM/DD HH24:MI
	 *
	 * @param dt
	...
	/**
	 * 根�?�指定的格�?转�?�java.sql.Timestamp到String
	 *
	 * @param dt
	 *            java.sql.Timestamp instance
	 * @param sFmt
	 *            Date 格�?，DATE_FORMAT_DATEONLY/DATE_FORMAT_DATETIME/
	 *            DATE_FORMAT_SESSION
	 * @return
	 * @since 1.0
	 * @history
	...
	/**
	 * Timestamp 格�?转�?��?yyyy-MM-dd timestampToSql(Timestamp 格�?转�?��?yyyy-MM-dd)
	 *
	 * @param timestamp
	 *            时间
	 ...
	 *            <pre>
	 * 		�?�值：
	 * 			COMP_MODEL_DATE		�?�比较日期，�?比较时间
	 * 			COMP_MODEL_TIME		�?�比较时间，�?比较日期
	...
	public static boolean isBetween(Date date, Date start, Date end, int interModel, int compModel) {
		if (date == null || start == null || end == null) {
			throw new IllegalArgumentException("日期�?能为空");
		}
		...
		default: {
			throw new IllegalArgumentException(String.format("日期的比较模�?[%d]有误", compModel));
		}
		}
		...
		default: {
			throw new IllegalArgumentException(String.format("日期的区间模�?[%d]有误", interModel));
		}
		}
	}
	...
	/**
	 * 当�?时间的�?几天，并且以例如2013/12/09 00:00:00 形�?输出
	 */
	...
	/**
	 * 判断开始时间和结�?�时间，是�?�超出了当�?时间的一定的间隔数�?制 如：开始时间和结�?�时间，�?能超出�?离当�?时间90天
	 *
	 * @param startDate
	 *            开始时间
	 * @param endDate
	...
	/**
	 * 判断开始时间和结�?�时间，是�?�超出了当�?时间的一定的间隔数�?制, 时间�?��?默认为天数 如：开始时间和结�?�时间，�?能超出�?离当�?时间90天
	 *
	 * @param startDate
	 *            开始时间
	 * @param endDate
	...
	public static Date getPreviousMonthFirstDay() {
		...
		lastDate.set(Calendar.DATE, 1);// 设为当�?月的1�?�
		lastDate.add(Calendar.MONTH, -1);// �?一个月，�?�为下月的1�?�
	...
	/**
	 * 获�?�几天内日期 return 2014-5-4�?2014-5-3
	 */
