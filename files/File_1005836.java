...
public class BugService extends NewBaseService<BugPO, BugQuery> implements ILuceneService, IConst {
    ...
    public BugPO getChangeBugPO(String id, String type, String value, BugLogPO bugLogPO, BugPO dbBug) throws Exception{
        ...
        if (PickCode.BUG_STATUS.getCode().equals(type)){
            BugStatus bugStatus = Optional.ofNullable(BugStatus.getByValue(value)).orElseThrow(() -> new MyException(MyError.E000065, "状�?有误"));
            ...
            BugSeverity bugSeverity = Optional.ofNullable(BugSeverity.getByValue(value)).orElseThrow(() -> new MyException(MyError.E000065, "严�?程度有误"));
            ...
            Optional.ofNullable(module.getId()).orElseThrow(() -> new MyException(MyError.E000065, "模�?�有误"));
            ...
            throw new MyException(MyError.E000065, "�?识别的类型：" + type);
        }
        return bug;
    }
}
