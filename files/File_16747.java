...
public class WorkFlowFormServiceImpl extends AbstractFlowableService implements WorkFlowFormService, DynamicFormInitializeCustomizer {
    ...
    public void customTableSetting(TableInitializeContext context) {
        ...
        //----------taskId--------------
        {
            ...
            processTaskId.setComment("�?程任务ID");
        ...
        //----------taskDefineKey--------------
        {
            ...
            taskDefineKey.setComment("�?程任务定义KEY");
        ...
        //----------taskName--------------
        {
            ...
            processTaskName.setComment("�?程任务定义�??称");
        ...
        //----------processDefineId--------------
        {
            ...
            processDefineId.setComment("�?程定义ID");
        ...
        //----------processDefineKey--------------
        {
            ...
            processDefineKey.setComment("�?程定义KEY");
        ...
        } //----------processDefineName--------------
        {
            ...
            processDefineName.setComment("�?程定义Name");
        ...
        //----------processDefineVersion--------------
        {
            ...
            processInstanceId.setComment("�?程实例ID");
        ...
        {//-----------lastUpdateTime---------
            ...
            lastUpdateTime.setComment("最�?�一次修改时间");
