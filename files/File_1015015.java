                                ...
                                .observe(ForwardActivity.this, new Observer<OperateResult<Integer>>() {
                                    ...
                                    public void onChanged(@Nullable OperateResult<Integer> integerOperateResult) {
                                        if (integerOperateResult.isSuccess()) {
                                            Toast.makeText(ForwardActivity.this, "è½¬å?‘æˆ?åŠŸ", Toast.LENGTH_SHORT).show();
                                            finish();
                                        } else {
                                            Toast.makeText(ForwardActivity.this, "è½¬å?‘å¤±è´¥" + integerOperateResult.getErrorCode(), Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                });
