...
public class SearchResultHttpUtil {
    ...
    public static HttpResult search(HPApplication hPApplication, Context context, String keyword, String page, String pagesize) {
        ...
        if (!NetUtil.isNetworkAvailable(context)) {
            ...
            httpResult.setErrorMsg("å½“å‰?ç½‘ç»œä¸?å?¯ç”¨");
...
//
        if (hPApplication.isWifi()) {
            if (!NetUtil.isWifi(context)) {
                ...
                httpResult.setErrorMsg("å½“å‰?ç½‘ç»œä¸?æ˜¯wifi");
            ...
            if (result != null) {
                ...
                if (status == 1) {
                    ...
                    for (int i = 0; i < infoJsonNode.length(); i++) {
                        ...
                        audioInfo.setSingerName(singerName.equals("")?"æœªçŸ¥":singerName);
                    ...
                    httpResult.setErrorMsg("è¯·æ±‚å‡ºé”™!");
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
