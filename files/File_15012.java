 ...
 * <br> 然�?�
 * <br> commentContainerView.setOnCommentClickListener(onCommentClickListener);//�?�必需
 * <br> commentContainerView.setOnDataChangedListener(onDataChangedListener);data = commentContainerView.getData();//�?�必需
 * <br> commentContainerView.setOnClickListener(onClickListener);//�?�必需
 * <br> ...
 */
public class CommentContainerView extends BaseView<List<CommentItem>> {
	...
	public void bindView(List<CommentItem> list){
		...
		llCommentContainerViewContainer.removeAllViews();//TODO 貌似比 �?�在count > 0时执行 性能更好，有待具体测试
	...
	/**设置最多显示数�?，超过则折�?�
	 * @param maxShowCount <= 0 ? 显示全部 : 超过则折�?�
	 * @must 在bindView�?调用
	 */
