...
public class SecondOrderHiddenMarkovModel extends HiddenMarkovModel
{
     ...
     * 构造�?马模型
     *
     * @param start_probability      �?始状�?概率�?��?
     * @param transition_probability 状�?转移概率矩阵
    ...
    public int[][] generate(int length)
    {
        ...
        os[1][0] = drawFrom(pi); // 采样首个�?状�?
        os[0][0] = drawFrom(B[os[1][0]]); // 根�?�首个�?状�?采样它的显状�?
    ...
    public float predict(int[] observation, int[] state)
    {
        ...
        // link[i][s][t] := 第i个时刻在�?一个状�?是s，当�?状�?是t时，�?2个状�?是什么
        ...
        // 从第三个时刻开始，使用�?一个时刻的概率矩阵乘以二阶转移张�?乘以�?�射概率矩阵
