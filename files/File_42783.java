...
public class ValidateUtils {
	...
	/**
	 * 判断传入�?�数是�?�为字�?与数字的组�?�字符串,而�?是�?�一的字�?或者数字
	 * 
	 * @param psw
	 * @return
	 */
	public static boolean isPassword(String pwd) {
		if (ValidateUtils.isInteger(pwd)) {// 是�?�全部为数字
			return false;// 全部为数字
		} else {
	 ...
	 * @param str
	 *            传入的字符串
	 * @return 是整数返回true,�?�则返回false capital
	 */
	...
	/**
	 * 判断是�?�为浮点数，包括double和float
	 * 
	 * @param str
	 *            传入的字符串
	 * @return 是浮点数返回true,�?�则返回false
	 */
	 ...
	 * @param str
	 *            传入的字符串
	 * @return 是Email样�?返回true,�?�则返回false
	 */
	...
	/**
	 * 是�?�为日期时间格�?：yyyy-MM-dd hh:mm:ss or yyyy-MM-dd hh:mm
	 * 
	 * @param dateTime
	 * @return
	 */
	...
	/**
	 * 验�?对象是�?�为NULL,空字符串，空数组，空的Collection或Map(�?�有空格的字符串也认为是空串)
	 * 
	 * @param obj
	 *            被验�?的对象
	 * @param message
	...
	/**
	 * 判断�?�数是�?��?�NULL,空字符串，空数组，空的Collection或Map(�?�有空格的字符串也认为是空串)
	 * 
	 * @param obj
	 * @return
	 */
	...
	public static String lengthValidate(String propertyName, String property, boolean isRequire, int minLength, int maxLength) {
		...
		if (isRequire && propertyLenght == 0) {
			return propertyName + "�?能为空，"; // 校验�?能为空
		} else if (isRequire && minLength != 0 && propertyLenght < minLength) {
			return propertyName + "�?能少于" + minLength + "个字符，"; // 必填情况下校验最少长度
		} else if (maxLength != 0 && propertyLenght > maxLength) {
			return propertyName + "�?能多于" + maxLength + "个字符，"; // 校验最大长度
		} else {
			return ""; // 校验通过则返回空字符串 .
		}
	}
