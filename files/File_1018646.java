...
public final class ExoPlayback implements Playback {
    ...
    public void play(QueueItem item, boolean isPlayWhenReady) {
        ...
        if (mediaHasChanged || mExoPlayer == null) {
            ...
            if (mExoPlayer == null) {
                ...
                @DefaultRenderersFactory.ExtensionRendererMode int extensionRendererMode =
                        rendererMode.equals(EXTENSION_RENDERER_MODE_ON) ?
                                ...
                                DefaultRenderersFactory.EXTENSION_RENDERER_MODE_OFF; //�?使用
            ...
            final AudioAttributes audioAttributes = new AudioAttributes.Builder()
                    ...
                    .build();
            mExoPlayer.setAudioAttributes(audioAttributes, true); //第二个�?�数能使ExoPlayer自动管�?�焦点
    ...
    /**
     * 指定语速 refer 是�?�已当�?速度为基数  multiple �?率
     */
    @Override
