 ...
 * <create-date>2017-10-27 下�?�5:06</create-date>
 *
 * <copyright file="PerceptronPOSTagger.java" company="�?农场">
...
public class PerceptronPOSTagger extends PerceptronTagger implements POSTagger
{
    public PerceptronPOSTagger(LinearModel model)
    {
        ...
        {
            throw new IllegalArgumentException(String.format("错误的模型类型: 传入的�?是�?性标注模型，而是 %s 模型", model.featureMap.tagSet.type));
        }
    }
     ...
     * 在线学习
     *
     * @param segmentedTaggedSentence 人民日报2014格�?的�?��?
    ...
    protected Instance createInstance(Sentence sentence, FeatureMap featureMap)
    {
        for (Word word : sentence.toSimpleWordList())
        {
            if (!model.featureMap.tagSet.contains(word.getLabel()))
                throw new IllegalArgumentException("在线学习�?�?�能学习新的标签: " + word + " ；请标注语料库�?��?新全�?训练。");
        }
