...
public class ProviderGroup {
     ...
     * 增加�?务列表
     *
     * @param providerInfo �?增加的�?务分组列表
     * @return 当�?�?务分组 provider group
     */
