...
public class AIMetaData extends Struct implements NativeResource {
    ...
    /** Returns a new {@code AIMetaData} instance allocated on the thread-local {@link MemoryStack}. */
    public static AIMetaData mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code AIMetaData} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
