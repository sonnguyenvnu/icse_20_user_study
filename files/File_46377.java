...
/**
 * å®¢æˆ·ç«¯ï¼šstartRpc â€”â€”&gt; filter --&gt; beforeSend --&gt; å­˜å…¥tracerä¿¡æ?¯ --&gt; clientReceived
 * æœ?åŠ¡ç«¯ï¼šserverReceived --&gt; filter --&gt; serverSend
 *
...
public class RestTracerAdapter {
    ...
    public static void storeTracerInfo(ClientRequestContext requestContext) {
        ...
        // tracerä¿¡æ?¯æ”¾å…¥request å?‘åˆ°æœ?åŠ¡ç«¯
    ...
    public static void serverFilter(ContainerRequestContext requestContext) {
        try {
            ...
            if (serverSpan != null) {
                ...
                serverSpan.setTag(RpcSpanTags.REMOTE_IP, context.getRemoteHostName()); // å®¢æˆ·ç«¯åœ°å?€
