...
public class CharUtil {
    ...
    public static void main(String[] args) {
        String url;
        System.out.println(utf8urlencode("�?莫"));
        System.out.println(iso2gb("�?莫"));
        System.out.println(gb2iso("�?莫"));
