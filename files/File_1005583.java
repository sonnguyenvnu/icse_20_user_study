    ...
    public String bindStub(PluginDescriptor pluginDescriptor, String pluginActivityClassName) {
            ...
            if (info.getTheme() != null) {
                ...
                if (loadedPlugin != null) {
                    try {
                        ...
                        if (styleId != 0) {
                            //maybe need cache
                            //根�?�目标Activity的主题id构造一个主题对象，
                            //并�?试从此主题中�?�出用于�?置�?明的属性：windowIsTranslucent
                            //如果�?�到了，说明目标Activity是使用的�?明主题
                            //则返回�?明主题的stubActivity
                    ...
                    LogUtil.e("�?�件尚未�?行，无法获�?�pluginResource对象");
                }
            }
        ...
        if (bindingMapping != null) {
            ...
            while (itr.hasNext()) {
                ...
                if (list == null || list.size() == 0) {
                    if (idleStubActivityName == null) {
                        ...
                        //这里找到空闲的stubactivity以�?�，还需继续�??历，用�?�检查是�?�pluginActivityClassName已�?绑定过了
                    }
                } else {
            ...
            if (idleStubActivityName != null) {
                ...
                //stub �?够用了
                LogUtil.e("stub�?够用了，需�?继续扩展stub�?��?�");
            }

        }

        //todo 或许需�?一个default更�?险一点？
        return "";
    }
