...
public class VideoMeetingActivity extends BaseActivity{
    ...
    public static String MEETING_NAME       = "CLASS_NAME";         //会议�??称
        ...
        dialog.findViewById(R.id.yes_btn).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(rtmpUrl)){
                    MLOC.showMsg(VideoMeetingActivity.this,"推�?地�?��?能为空");
                }else{
                    pushRtmp(rtmpUrl);
                    dialog.dismiss();
                }
    ...
    private void pushRtmp(String url){
        meetingManager.pushRtmp(url, new IXHResultCallback() {
            ...
            public void success(Object data) {
                rtmpPushing = true;
                MLOC.showMsg(VideoMeetingActivity.this,"推�?�?功");
                ((TextView)findViewById(R.id.push_rtmp)).setText("�?�止");
            }

            @Override
            public void failed(final String errMsg) {
                rtmpPushing = false;
                MLOC.showMsg(VideoMeetingActivity.this,"推�?失败"+errMsg);
    ...
    private void stopPushRtmp(){
        meetingManager.stopPushRtmp( new IXHResultCallback() {
            ...
            public void success(Object data) {
                rtmpPushing = false;
                MLOC.showMsg(VideoMeetingActivity.this,"�?�止推�?�?功");
                ((TextView)findViewById(R.id.push_rtmp)).setText("RTMP");
            }

            @Override
            public void failed(final String errMsg) {
                MLOC.showMsg(VideoMeetingActivity.this,"�?�止推�?失败"+errMsg);
            }
        });
    }
