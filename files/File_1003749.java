 ...
 * Methods such as {@link #map(Function)}, {@link #flatMap(Function)}, {@link #cache()} etc.) allow a pipeline of â€œoperationsâ€?Â to be specified,
 ...
 * <p>
 * The promise is not â€œactivatedâ€? until the {@link #then(Action)} method is called.
...
public interface Promise<T> {
   ...
   * }</pre>
   * <p>
   * The â€œupstreamTransformerâ€? function takes an upstream data source, and returns another upstream that wraps it.
   ...
   * <p>
   * This method can be used to apply custom operations without breaking the â€œcode flowâ€?.
   ...
   * <p>
   * This method can be useful when needing to convert a promise to another type as it facilitates doing so without breaking the â€œcode flowâ€?.
   ...
   * <p>
   * Any exception thrown by the function â€“ possibly the exception it receives as an argument â€“ will
