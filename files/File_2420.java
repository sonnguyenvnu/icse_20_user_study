 ...
 */
@Controller
@Api(value = "æ?ƒé™?ç®¡ç?†", description = "æ?ƒé™?ç®¡ç?†")
...
public class UpmsPermissionController extends BaseController {
    ...
    @ApiOperation(value = "è§’è‰²æ?ƒé™?åˆ—è¡¨")
    @RequiresPermissions("upms:permission:read")
    ...
    @ApiOperation(value = "ç”¨æˆ·æ?ƒé™?åˆ—è¡¨")
    @RequiresPermissions("upms:permission:read")
    ...
    public Object create(UpmsPermission upmsPermission) {
        ComplexResult result = FluentValidator.checkAll()
                .on(upmsPermission.getName(), new LengthValidator(1, 20, "å??ç§°"))
                .doValidate()
