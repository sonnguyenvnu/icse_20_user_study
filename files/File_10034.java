...
public class InitMgmtService {
    ...
    public void initSym() {
        ...
        try {
            ...
            tag.put(Tag.TAG_DESCRIPTION, "[Sym](https://github.com/b3log/symphony) 是一款用 Java 实现的现代化社区（论�?�/BBS/社交网络/�?�客）平�?�，“下一代的社区系统，为未�?�而构建�?。");
            tagMgmtService.updateTag(tagId, tag);
            ...
            article.put(Article.ARTICLE_TITLE, "欢迎�?�到 Sym 社区 :gift_heart:");
            article.put(Article.ARTICLE_TAGS, "系统公告,Sym");
            article.put(Article.ARTICLE_CONTENT, "社区愿景�?行为准则�?功能等请在此进行�??述介�?。");
