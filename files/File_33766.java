...
/**
 * �?�以�?�消底部分割线的ItemDecoration
 * copied from DividerItemDecoration
 * mIsShowBottomDivider  false �?显示底部分割线
 * mIsShowFirstDivider   false �?显示第一个item的分割线
 * mIsShowSecondDivider  false �?显示第二个item的分割线
 *
 * @author Ethan Lee
 */
public class MyDividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private void drawVertical(Canvas canvas, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            // mIsShowBottomDivider false的时候�?绘制最�?�一个view的divider
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent,
        ...
        if (mOrientation == VERTICAL) {
            //parent.getChildCount() �?能拿到item的总数
