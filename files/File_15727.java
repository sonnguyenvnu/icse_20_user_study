...
/**
 * æ•°æ?®æ?ƒé™?å­—æ®µè¿‡æ»¤å¤„ç?†,ç›®å‰?ä»…æ”¯æŒ?deny. {@link DataAccessConfig.DefaultType#DENY_FIELDS}
 *
 * @author zhouhao
 */
public class FieldFilterDataAccessHandler implements DataAccessHandler {
    ...
    /**
     * @param accesses ä¸?å?¯æ“?ä½œçš„å­—æ®µ
     * @param params   å?‚æ•°ä¸Šä¸‹æ–‡
     * @return true
     * @see BeanUtilsBean
