...
public class OrderController {
    ...
    @ApiOperation(value = "测试订�?�支付接�?�(这里是压测接�?��?添加分布�?事务)")
    ...
    @ApiOperation(value = "模拟下�?�付款�?作在Confirm阶段异常，此时所有的系统调用都会执行cancel方法，达到数�?�的一致性（注�?:这里模拟的是系统异常，或者rpc异常）")
    ...
    @ApiOperation(value = "模拟下�?�付款�?作在Confirm阶段异常，此时所有的系统调用都会执行cancel方法，达到数�?�的一致性（异常指的是超时异常）")
