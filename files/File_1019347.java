...
public class AdminsProductAttrController {
    ...
    @ApiOperation(value = "获得规格树结构", notes = "该接�?�返回的信�?�更为精简。一般用于�?端缓存数�?�字典到本地。")
    ...
    @ApiOperation(value = "创建商�?规格")
    @ApiImplicitParams({
            @ApiImplicitParam(name = "name", value = "规格�??", required = true, example = "颜色")
    })
    ...
    @ApiOperation(value = "修改商�?规格")
    @ApiImplicitParams({
            @ApiImplicitParam(name = "id", value = "规格编�?�", required = true, example = "1"),
            @ApiImplicitParam(name = "name", value = "规格�??", required = true, example = "颜色")
    })
    ...
    @ApiOperation(value = "修改商�?规格状�?")
    @ApiImplicitParams({
            @ApiImplicitParam(name = "id", value = "规格编�?�", required = true, example = "100"),
            @ApiImplicitParam(name = "status", value = "状�?", required = true, example = "1")
    })
    ...
    // TODO 芋艿 暂时�?考虑 delete Attr 。因为关�?�逻辑比较多

    @PostMapping("/attr_value/add")
    @ApiOperation(value = "创建商�?规格值")
    @ApiImplicitParams({
            @ApiImplicitParam(name = "attrId", value = "规格编�?�", required = true, example = "100"),
            @ApiImplicitParam(name = "name", value = "规格值", required = true, example = "�?色")
    })
    ...
    @ApiOperation(value = "修改商�?规格值")
    @ApiImplicitParams({
            @ApiImplicitParam(name = "id", value = "规格值编�?�", required = true, example = "100"),
            @ApiImplicitParam(name = "name", value = "规格值", required = true, example = "�?色")
    })
    ...
    // TODO 芋艿 暂时�?考虑 delete Attr Value 。因为关�?�逻辑比较多
