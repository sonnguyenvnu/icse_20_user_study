...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    public SlidingTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        setFillViewport(true);//设置滚动视图是�?��?�以伸缩其内容以填充视�?�
    ...
    /** 关�?�ViewPager,用于�?想在ViewPager适�?器中设置titles数�?�的情况 */
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
    ...
    public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
        /**
         * position:当�?View的�?置
         * mCurrentPositionOffset:当�?View的�??移�?比例.[0,1)
         */
    ...
    /** HorizontalScrollView滚到当�?tab,并且居中显示 */
    private void scrollToCurrentTab() {
        ...
        /**当�?Tab的left+当�?Tab的Width乘以positionOffset*/
        int newScrollX = mTabsContainer.getChildAt(mCurrentTab).getLeft() + offset;

        if (mCurrentTab > 0 || offset > 0) {
            /**HorizontalScrollView移动到当�?tab,并居中*/
        ...
        if (newScrollX != mLastScrollX) {
            ...
            /** scrollTo（int x,int y）:x,y代表的�?是�??标点,而是�??移�?
             *  x:表示离起始�?置的x水平方�?�的�??移�?
             *  y:表示离起始�?置的y垂直方�?�的�??移�?
             */
    ...
    /** 设置未读消�?��??移,原点为文字的�?�上角.当控件高度固定,消�?��??示�?置易控制,显示效果佳 */
    ...
    class InnerPagerAdapter extends FragmentPagerAdapter {
        ...
        public void destroyItem(ViewGroup container, int position, Object object) {
            // 覆写destroyItem并且空实现,这样�?个Fragment中的视图就�?会被销�?
