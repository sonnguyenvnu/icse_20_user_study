...
public class ClusterAnalyzer<K>
{
     ...
     *                   │   └── ...<br>
     *                   └── ...<br>
     *                   文件�?一定需�?用数字命�??,也�?需�?以txt作为�?�缀�??,但一定需�?是文本文件.
     * @param algorithm  kmeans 或 repeated bisection
     * @throws IOException 任何�?�能的IO异常
     */
