 ...
 */
@RestController
@Api(tags = "OAuth2.0-æœ?åŠ¡-èŽ·å?–ç”¨æˆ·ä¿¡æ?¯", value = "OAuth2.0-æœ?åŠ¡-èŽ·å?–ç”¨æˆ·ä¿¡æ?¯")
...
public class OAuth2UserInfoController {
    ...
    @GetMapping
    @ApiOperation("æ ¹æ?®accessTokenèŽ·å?–å¯¹åº”ç”¨æˆ·ä¿¡æ?¯")
    ...
    @GetMapping("/{userId}")
    @ApiOperation("æ ¹æ?®accessTokenèŽ·å?–ç‰¹å®šçš„ç”¨æˆ·ä¿¡æ?¯")
