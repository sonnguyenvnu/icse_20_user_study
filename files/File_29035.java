...
public class DemoCodeUtil {
    ...
    static {
        redisCluster.add("/**                                                                       ");
        redisCluster.add(" * 使用自定义�?置：                                                         ");
        redisCluster.add(" *  1. setTimeout：redis�?作的超时设置；                                    ");
        redisCluster.add(" *  2. setMaxRedirections：节点定�?�?试的次数；                              ");
        redisCluster.add(" */                                                                       ");
        ...
        //redis-sentinel的spring�?置
        redisSentinelSpring.add("//spring �?置");
        ...
        redisSentinelSpring.add("&lt;!--高效的�?列化工具--/&gt");
        ...
        redisSentinelSpring.add("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;//根�?�自己需�?设置poolConfig");
        ...
        redisSentinelSpring.add("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;//根�?�自己需�?设置超时时间");
        ...
        // redis-cluster的spring�?置
        redisClusterSpring.add("//spring �?置");
        ...
        redisClusterSpring.add("&lt;!--高效的�?列化工具--/&gt");
        ...
        redisClusterSpring.add("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;//根�?�自己需�?设置poolConfig");
        ...
        redisClusterSpring.add("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;//根�?�自己需�?修改�?�数");
