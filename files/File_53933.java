...
public class AIMatrix4x4 extends Struct implements NativeResource {
    ...
    /** Returns a new {@code AIMatrix4x4} instance allocated on the thread-local {@link MemoryStack}. */
    public static AIMatrix4x4 mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code AIMatrix4x4} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
