...
public class OrganizationDictionary
{
    ...
    static
    {
        ...
        if (dictionary.load(HanLP.Config.OrganizationDictionaryPath))
            logger.info(HanLP.Config.OrganizationDictionaryPath + "加载�?功，耗时" + (System.currentTimeMillis() - start) + "ms");
        else
...
//        ListIterator<Vertex> listIterator = vertexList.listIterator();
    ...
    /**
     * 因为任何算法都无法解决100%的问题，总是有一些bad case，这些bad case会以“�?��? Z 1�?的形�?加入�?典中<BR>
     * 这个方法返回是�?�是bad case
     *
     * @param name
     * @return
