...
public class TabsTag extends JeecgTag {
	...
	private boolean plain;// 简�?模�?
	private boolean fit = true;// 铺满�?览器
	private boolean border;// 边框
	private String scrollIncrement;// 滚动增�?
	private String scrollDuration;// 滚动时间
	private boolean tools;// 工具�?
	private boolean tabs = true;// 是�?�创建父容器
	private boolean iframe = true;// 是�?�是iframe方�?
	private String tabPosition = "top";// 选项�?��?置
	...
	public StringBuffer end() {
		...
		if (tabs) {
				//增加width属性，fit属性之�?写死，改为由页�?�设定，�?填默认true
