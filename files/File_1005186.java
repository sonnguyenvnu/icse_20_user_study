...
public class DepartSelectTag extends TagSupport {
	...
	private String selectedIdsInputId;      // 用于记录已选择部门编�?�的input的id
	private String selectedNamesInputId;    // 用于显示已选择部门�??称的input的name
	private String inputWidth;     			//输入框宽度
	private String windowWidth; 			//弹出窗�?�宽度
	private String windowHeight; 			//弹出窗�?�高度
	private String departIdsDefalutVal; 	//部门ids 默认值
	private String departNamesDefalutVal;	//部门names 默认值
	private String readonly = "readonly";	// �?�读属性
	private boolean hasLabel = false;       //是�?�显示lable,默认�?显示
