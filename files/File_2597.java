...
public class MDAGNode
{
     ...
     * @param isAcceptNode     是�?�是终止状�? a boolean denoting the accept state status of this node
     */
    ...
    /**
     * 克隆一个状�?<br>
     * 原�?�soleParentNode转移到本状�?，现在转移到克隆�?�的状�?
