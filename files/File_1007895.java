...
public class StatusBarUtil {
    ...
    /** 设置状�?�?darkMode,字体颜色�?�icon�?�黑(目�?支�?MIUI6以上,Flyme4以上,Android M以上) */
...
//        window.setStatusBarColor(Color.TRANSPARENT);
    ...
    /**
     * 设置Flyme4+的darkMode,darkMode时候字体颜色�?�icon�?�黑
    ...
    /**
     * 设置MIUI6+的状�?�?是�?�为darkMode,darkMode时候字体颜色�?�icon�?�黑
    ...
    /** 增加View的paddingTop,增加的值为状�?�?高度 (智能判断，并设置高度)*/
    ...
    /** 增加View的高度以�?�paddingTop,增加的值为状�?�?高度.一般是在沉浸�?全�?给ToolBar用的 */
    ...
    /** 增加View上边�?（MarginTop）一般是给高度为 WARP_CONTENT 的�?控件用的*/
