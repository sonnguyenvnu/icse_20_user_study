...
public class TransOrderServiceImpl extends BaseService4TransOrder implements ITransOrderService {
    ...
    public Map create(String jsonParam) {
        ...
        if (ObjectValidUtil.isInvalid(bizParamMap)) {
            _log.warn("æ–°å¢žè½¬è´¦è®¢å?•å¤±è´¥, {}. jsonParam={}", RetEnum.RET_PARAM_NOT_FOUND.getMessage(), jsonParam);
        ...
        if(transOrderObj == null) {
            _log.warn("æ–°å¢žè½¬è´¦è®¢å?•å¤±è´¥, {}. jsonParam={}", RetEnum.RET_PARAM_INVALID.getMessage(), jsonParam);
    ...
    public Map select(String jsonParam) {
        ...
        Map<String, Object> bizParamMap = baseParam.getBizParamMap();
        if (ObjectValidUtil.isInvalid(bizParamMap)) {
            _log.warn("æ ¹æ?®è½¬è´¦è®¢å?•å?·æŸ¥è¯¢è½¬è´¦è®¢å?•å¤±è´¥, {}. jsonParam={}", RetEnum.RET_PARAM_NOT_FOUND.getMessage(), jsonParam);
            return RpcUtil.createFailResult(baseParam, RetEnum.RET_PARAM_NOT_FOUND);
        }
        ...
        if (ObjectValidUtil.isInvalid(transOrderId)) {
            _log.warn("æ ¹æ?®è½¬è´¦è®¢å?•å?·æŸ¥è¯¢è½¬è´¦è®¢å?•å¤±è´¥, {}. jsonParam={}", RetEnum.RET_PARAM_INVALID.getMessage(), jsonParam);
            return RpcUtil.createFailResult(baseParam, RetEnum.RET_PARAM_INVALID);
        }
    ...
    public Map selectByMchIdAndTransOrderId(String jsonParam) {
        ...
        Map<String, Object> bizParamMap = baseParam.getBizParamMap();
        if (ObjectValidUtil.isInvalid(bizParamMap)) {
            _log.warn("æ ¹æ?®å•†æˆ·å?·å’Œè½¬è´¦è®¢å?•å?·æŸ¥è¯¢è½¬è´¦è®¢å?•å¤±è´¥, {}. jsonParam={}", RetEnum.RET_PARAM_NOT_FOUND.getMessage(), jsonParam);
            return RpcUtil.createFailResult(baseParam, RetEnum.RET_PARAM_NOT_FOUND);
        }
        ...
        if (ObjectValidUtil.isInvalid(mchId, transOrderId)) {
            _log.warn("æ ¹æ?®å•†æˆ·å?·å’Œè½¬è´¦è®¢å?•å?·æŸ¥è¯¢è½¬è´¦è®¢å?•å¤±è´¥, {}. jsonParam={}", RetEnum.RET_PARAM_INVALID.getMessage(), jsonParam);
            return RpcUtil.createFailResult(baseParam, RetEnum.RET_PARAM_INVALID);
        }
    ...
    public Map selectByMchIdAndMchTransNo(String jsonParam) {
        ...
        Map<String, Object> bizParamMap = baseParam.getBizParamMap();
        if (ObjectValidUtil.isInvalid(bizParamMap)) {
            _log.warn("æ ¹æ?®å•†æˆ·å?·å’Œå•†æˆ·è®¢å?•å?·æŸ¥è¯¢æ”¯ä»˜è®¢å?•å¤±è´¥, {}. jsonParam={}", RetEnum.RET_PARAM_NOT_FOUND.getMessage(), jsonParam);
            return RpcUtil.createFailResult(baseParam, RetEnum.RET_PARAM_NOT_FOUND);
        }
        String mchId = baseParam.isNullValue("mchId") ? null : bizParamMap.get("mchId").toString();
        ...
        if (ObjectValidUtil.isInvalid(mchId, mchTransNo)) {
            _log.warn("æ ¹æ?®å•†æˆ·å?·å’Œå•†æˆ·è®¢å?•å?·æŸ¥è¯¢æ”¯ä»˜è®¢å?•å¤±è´¥, {}. jsonParam={}", RetEnum.RET_PARAM_INVALID.getMessage(), jsonParam);
            return RpcUtil.createFailResult(baseParam, RetEnum.RET_PARAM_INVALID);
        }
    ...
    public Map updateStatus4Ing(String jsonParam) {
        ...
        Map<String, Object> bizParamMap = baseParam.getBizParamMap();
        if (ObjectValidUtil.isInvalid(bizParamMap)) {
            _log.warn("ä¿®æ”¹è½¬è´¦è®¢å?•çŠ¶æ€?å¤±è´¥, {}. jsonParam={}", RetEnum.RET_PARAM_NOT_FOUND.getMessage(), jsonParam);
            return RpcUtil.createFailResult(baseParam, RetEnum.RET_PARAM_NOT_FOUND);
        }
        String transOrderId = baseParam.isNullValue("transOrderId") ? null : bizParamMap.get("transOrderId").toString();
        String channelOrderNo = baseParam.isNullValue("channelOrderNo") ? null : bizParamMap.get("channelOrderNo").toString();
        if (ObjectValidUtil.isInvalid(transOrderId)) {
            _log.warn("ä¿®æ”¹è½¬è´¦è®¢å?•çŠ¶æ€?å¤±è´¥, {}. jsonParam={}", RetEnum.RET_PARAM_INVALID.getMessage(), jsonParam);
            return RpcUtil.createFailResult(baseParam, RetEnum.RET_PARAM_INVALID);
        }
    ...
    public Map sendTransNotify(String jsonParam) {
        ...
        Map<String, Object> bizParamMap = baseParam.getBizParamMap();
        if (ObjectValidUtil.isInvalid(bizParamMap)) {
            _log.warn("å?‘é€?è½¬è´¦è®¢å?•å¤„ç?†å¤±è´¥, {}. jsonParam={}", RetEnum.RET_PARAM_NOT_FOUND.getMessage(), jsonParam);
            return RpcUtil.createFailResult(baseParam, RetEnum.RET_PARAM_NOT_FOUND);
        }
        String msg = baseParam.isNullValue("msg") ? null : bizParamMap.get("msg").toString();
        if (ObjectValidUtil.isInvalid(msg)) {
            _log.warn("å?‘é€?è½¬è´¦è®¢å?•å¤„ç?†å¤±è´¥, {}. jsonParam={}", RetEnum.RET_PARAM_INVALID.getMessage(), jsonParam);
            return RpcUtil.createFailResult(baseParam, RetEnum.RET_PARAM_INVALID);
        }
        int result = 1;
        try {
