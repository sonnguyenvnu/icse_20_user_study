...
public class PhantomJSDownloader extends AbstractDownloader {
    ...
    /**
     * 添加新的构造函数，支�?phantomjs自定义命令
     * 
     * example: 
     *    phantomjs.exe 支�?windows环境
     *    phantomjs --ignore-ssl-errors=yes 忽略抓�?�地�?�是https时的一些错误
     *    /usr/local/bin/phantomjs 命令的�?对路径，�?��?因系统环境�?��?引起的IOException
     *   
    ...
    /**
     * 新增构造函数，支�?crawl.js路径自定义，因为当其他项目�?赖此jar包时，runtime.exec()执行phantomjs命令时无使用法jar包中的crawl.js
     * <pre>
     * crawl.js start --
     * 
