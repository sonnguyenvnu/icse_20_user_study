...
public class TableRenameConfigurationPlugin extends BasePlugin implements ITableConfigurationHook {
    ...
    public static final String PRO_TABLE_REPLACE_STRING = "domainObjectRenamingRule.replaceString";  // 替�?� property
    public static final String PRO_TABLE_REPLACE_DISABLE = "domainObjectRenamingRule.disable";  // 替�?� property
    public static final String PRO_COLUMN_SEARCH_STRING = "columnRenamingRule.searchString";  // 查找 property
    public static final String PRO_COLUMN_REPLACE_STRING = "columnRenamingRule.replaceString";  // 替�?� property
    public static final String PRO_COLUMN_REPLACE_DISABLE = "columnRenamingRule.disable";  // 替�?� property
    ...
    public boolean validate(List<String> warnings) {
        ...
        this.columnReplaceString = properties.getProperty(PRO_COLUMN_REPLACE_STRING);  // 和官方行为�?�?一致
    ...
    public void tableConfiguration(IntrospectedTable introspectedTable) {
        try {
            ...
            if (tableConfiguration.getColumnRenamingRule() == null
                ...
                // introspectedTable 使用到的所有column过滤并替�?�
