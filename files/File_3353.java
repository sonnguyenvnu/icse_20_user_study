...
public class MaxEntModel
{
    ...
    public static MaxEntModel create(String path)
    {
        ...
        try
        {
            ...
            for (int i = 0; i < NUM_PREDS; i++)
            {
                ...
                assert !tmpMap.containsKey(predLabels[i]) : "�?�?的键： " + predLabels[i] + " 请使用 -Dfile.encoding=UTF-8 训练";
     ...
     * @param txtPath txt的路径，�?�使�?存在.txt，�?�存在.bin，也应传入txt的路径，方法内部会自动加.bin�?�缀
     * @return
     */
