...
public class BGFXTextureInfo extends Struct implements NativeResource {
    ...
    /** Returns a new {@code BGFXTextureInfo} instance allocated on the thread-local {@link MemoryStack}. */
    public static BGFXTextureInfo mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code BGFXTextureInfo} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
