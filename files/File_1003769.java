...
public class Streams {
   ...
   * @param valveReceiver an action that receives a runnable â€œvalveâ€? that when run allows request to start flowing upstream
   * @param <T> the type of item emitted
   ...
   * An execution bound publisher emits all of its â€œsignalsâ€? (e.g. {@code onNext()}) on its execution (and therefore same thread).
   ...
   * <p>
   * The given {@code disposer} is used to â€œfreeâ€? any items that were not yet received by the subscriber when
