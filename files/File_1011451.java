...
@Generated
public class Template_reduce_reflectiveInvokeThis extends TemplateDeclarationBase implements TemplateDeclaration2 {
  ...
  protected FragmentResult applyPart0(@NotNull final TemplateContext context) throws GenerationException {
    ...
    try {
      tnode1.setReference(myAssociationLinks[0], SReference.create(myAssociationLinks[0], tnode1, PersistenceFacade.getInstance().createModelReference("d936855b-48da-4812-a8a0-2bfddd633ac5/java:jetbrains.mps.smodel.behaviour(jetbrains.mps.lang.behavior.api/)"), PersistenceFacade.getInstance().createNodeId("~BHReflection.invoke(org.jetbrains.mps.openapi.language.SAbstractConcept,jetbrains.mps.core.aspects.behaviour.api.SMethodId,java.lang.Object...)")));
      ...
      TemplateContext context1 = context.subContext();
      {
        ...
        SNode callInputNode2 = QueriesGenerated.sourceNodeQuery_108_0(new SourceSubstituteMacroNodeContext(context1, callMacro_f0s0cy_b0a0a1a3a2a6));
      ...
      }
      {
        ...
        try {
          ...
          TemplateContext context3 = context1.subContext();
          {
            ...
            try {
              SNodeAccessUtil.setProperty(tnode6, myProperties[0], TemplateUtil.asString(QueriesGenerated.propertyMacro_GetValue_108_0(new PropertyMacroContext(context3, "foo", propertyMacro_f0s0cy_c0a0c0a0b0d0b0f0c0g))));
            } finally {
            }
          ...
          }
          {
            ...
            if (QueriesGenerated.ifMacro_Condition_108_0(new IfMacroContext(context3, ifMacroRef_f0s0cy_b0a0b0e0b0f0c0g))) {
              ...
              try {
                environment.resolve(new RefResolver(tnode8, myAssociationLinks[2], context3, new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "3099391750892236464"), "BaseConcept") {
                  @Override
                  public Object resolve() {
                    return QueriesGenerated.referenceMacro_GetReferent_108_1(createQueryContext());
                  }
                });
              } finally {
              }
          ...
          }
          {
            ...
            try {
              SNodeAccessUtil.setProperty(tnode11, myProperties[0], TemplateUtil.asString(QueriesGenerated.propertyMacro_GetValue_108_1(new PropertyMacroContext(context3, "1234567890", propertyMacro_f0s0cy_c0a0c0a0b0f0b0f0c0g))));
            } finally {
            }
      ...
      }
      {
        ...
        context4 = context1.withVariable("methodDeclaration", ((SNode) QueriesGenerated.templateArgumentQuery_108_0(new TemplateArgumentContext(context1, new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "3099391750892236517")))));
        tlist12 = new Template_reduce_Parameters().apply(environment, context4);
  ...
  private static SNodePointer callMacro_f0s0cy_b0a0a1a3a2a6 = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "3099391750892236403");
  private static SNodePointer propertyMacro_f0s0cy_c0a0c0a0b0d0b0f0c0g = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "3099391750892236448");
  private static SNodePointer ifMacroRef_f0s0cy_b0a0b0e0b0f0c0g = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "3099391750892236479");
  private static SNodePointer propertyMacro_f0s0cy_c0a0c0a0b0f0b0f0c0g = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "3099391750892236500");
}
