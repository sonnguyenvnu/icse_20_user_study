...
public class AdminFieldController extends Controller {
     ...
     * 验�?字段数�?�
     */
    @NotNullValidate(value = "val",message = "字段校验�?�数错误")
    @NotNullValidate(value = "types",message = "字段校验�?�数错误")
    @NotNullValidate(value = "name",message = "字段校验�?�数错误")
    public void verify(){
     ...
     * 查询客户管�?�列表页字段
     */
    @NotNullValidate(value = "label",message = "label�?能为空")
     ...
     */
    @NotNullValidate(value = "label",message = "label�?能为空")
    @NotNullValidate(value = "noHideIds",message = "显示列�?能为空")
