...
/**
 * 自定义下拉框，使用AppCompatTextView + PopupWindow组�?�实现
 *
 * @author xuexiang
 * @since 2018/12/7 下�?�4:24
 */
public class MaterialSpinner extends AppCompatTextView {
    ...
    /**
     * 计算出�?�的�?置，y方�?�就在anchorView的上�?�和下�?�对�?显示，x方�?�就是与�?幕�?�边对�?显示
     * 如果anchorView的�?置有�?�化，就�?�以适当自己�?外加入�??移�?�修正
     *
     * @param anchorView 呼出window的view
     * @return window显示的左上角的xOff, yOff�??标
     */
    private int[] calculatePopWindowPos(final View anchorView) {
        final int windowPos[] = new int[2];
        final int anchorLoc[] = new int[2];
        // 获�?�锚点View在�?幕上的左上角�??标�?置
