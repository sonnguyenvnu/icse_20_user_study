...
public class Select extends Query {
	...
	public void addOrderBy(String nestedPath, String name, String type, ScriptSortBuilder.ScriptSortType scriptSortType) {
		if ("_score".equals(name)) { //zhongshu-comment å?¯ä»¥ç›´æŽ¥åœ¨order byå­?å?¥ä¸­å†™_scoreï¼Œæ ¹æ?®è¯¥å­—æ®µæŽ’åº? select * from tbl order by _score asc
			isQuery = true;
		}
