...
public class RxGalleryFinalApi {
    ...
    public static File fileImagePath;//�?照图片
    public static File cropImagePath;//�?剪图片
     ...
     * 打开相机
     * <p>
     * fragment 或者 activity 直接传入  this，  内部处�?�
     * <p>
     * 这里的 Fragment 指的是 v4包下的Fragment
     *
     * @see Fragment
     * <p>
     * M 以上的�?��?处�?�，�?照以�?�读�?�相册需�?自行申请，这里�?�?�处�?�
     * <p>
     * 返回值： -1 ： 设备没有相机
     */
