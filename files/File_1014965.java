...
public class CrmContractService {
    ...
    public List<Record> information(Integer id) {
        ...
        field.set("å?ˆå?Œç¼–å?·", record.getStr("num"))
                .set("å?ˆå?Œå??ç§°", record.getStr("name"))
                .set("å®¢æˆ·å??ç§°", record.getStr("customer_name"))
                .set("å•†æœºå??ç§°", record.getStr("business_name"))
                .set("ä¸‹å?•æ—¶é—´", DateUtil.formatDate(record.getDate("order_date")))
                .set("å?ˆå?Œé‡‘é¢?", record.getStr("money"))
                .set("å?ˆå?Œå¼€å§‹æ—¶é—´", DateUtil.formatDate(record.getDate("start_time")))
                .set("å?ˆå?Œç»“æ?Ÿæ—¶é—´", DateUtil.formatDate(record.getDate("end_time")))
                .set("å®¢æˆ·ç­¾çº¦äºº", record.getStr("contacts_name"))
                .set("å…¬å?¸ç­¾çº¦äºº", record.getStr("company_user_name")).
    ...
    public R saveAndUpdate(JSONObject jsonObject) {
        ...
        if (crmContract.getContractId() == null) {
            ...
            if (contract != 0){
                return R.error("å?ˆå?Œç¼–å?·å·²å­˜åœ¨ï¼Œè¯·æ ¡å¯¹å?Žå†?æ·»åŠ ï¼?");
            }
    ...
    /**
     * @author zxy
     * æŸ¥è¯¢å?ˆå?Œè‡ªå®šä¹‰å­—æ®µï¼ˆæ·»åŠ ï¼‰
     */
    public List<Record> queryField() {
        List<Record> fieldList = new ArrayList<>();
        String[] settingArr = new String[]{};
        fieldUtil.getFixedField(fieldList, "num", "å?ˆå?Œç¼–å?·", "", "number", settingArr, 1);
        fieldUtil.getFixedField(fieldList, "name", "å?ˆå?Œå??ç§°", "", "text", settingArr, 1);
        fieldUtil.getFixedField(fieldList, "customerId", "å®¢æˆ·å??ç§°", settingArr, "customer", settingArr, 1);
        fieldUtil.getFixedField(fieldList, "businessId", "å•†æœºå??ç§°", settingArr, "business", settingArr, 0);
        fieldUtil.getFixedField(fieldList, "orderDate", "ä¸‹å?•æ—¶é—´", "", "date", settingArr, 0);
        fieldUtil.getFixedField(fieldList, "money", "å?ˆå?Œé‡‘é¢?", "", "floatnumber", settingArr, 1);
        fieldUtil.getFixedField(fieldList, "startTime", "å?ˆå?Œå¼€å§‹æ—¶é—´", "", "date", settingArr, 0);
        fieldUtil.getFixedField(fieldList, "endTime", "å?ˆå?Œç»“æ?Ÿæ—¶é—´", "", "date", settingArr, 0);
        fieldUtil.getFixedField(fieldList, "contactsId", "å®¢æˆ·ç­¾çº¦äºº", settingArr, "contacts", settingArr, 0);
        fieldUtil.getFixedField(fieldList, "companyUserId", "å…¬å?¸ç­¾çº¦äºº", settingArr, "user", settingArr, 0);
    ...
    /**
     * @author zxy
     * æŸ¥è¯¢å?ˆå?Œè‡ªå®šä¹‰å­—æ®µï¼ˆç¼–è¾‘ï¼‰
     */
//    public List<Record> queryField(Integer contractId) {
//        List<Record> fieldList = new ArrayList<>();
//        Record record = Db.findFirst("select * from contractview where contract_id = ?", contractId);
//        String[] settingArr = new String[]{};
//        fieldUtil.getFixedField(fieldList, "num", "å?ˆå?Œç¼–å?·", record.getStr("num"), "number", settingArr, 1);
//        fieldUtil.getFixedField(fieldList, "name", "å?ˆå?Œå??ç§°", record.getStr("name"), "text", settingArr, 1);
...
//        }
//
//        fieldUtil.getFixedField(fieldList, "businessId", "å•†æœºå??ç§°", customerList, "business", settingArr, 0);
//        fieldUtil.getFixedField(fieldList, "orderDate", "ä¸‹å?•æ—¶é—´", DateUtil.formatDateTime(record.get("order_date")), "date", settingArr, 0);
//        fieldUtil.getFixedField(fieldList, "money", "å?ˆå?Œé‡‘é¢?", record.getStr("money"), "floatnumber", settingArr, 1);
//        fieldUtil.getFixedField(fieldList, "startTime", "å?ˆå?Œå¼€å§‹æ—¶é—´", DateUtil.formatDateTime(record.get("start_time")), "date", settingArr, 0);
//        fieldUtil.getFixedField(fieldList, "endTime", "å?ˆå?Œç»“æ?Ÿæ—¶é—´", DateUtil.formatDateTime(record.get("end_time")), "date", settingArr, 0);
//        customerList = new ArrayList<>();
...
//        }
//        fieldUtil.getFixedField(fieldList, "contactsId", "å®¢æˆ·ç­¾çº¦äºº", customerList, "contacts", settingArr, 0);
//        customerList = new ArrayList<>();
...
//        }
//        fieldUtil.getFixedField(fieldList, "companyUserId", "å…¬å?¸ç­¾çº¦äºº", customerList, "user", settingArr, 0);
