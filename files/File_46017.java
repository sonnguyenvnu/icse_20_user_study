...
public class FaultToleranceConfig {
    ...
    /**
     * �?�时开始,调用多少次以上�?调控,如果�?足,�?处�?�.无需调控.
     */
    private long    leastCallCount                   = 100L;

    /**
     * 默认InvocationStat如果�?�?�与统计的窗�?�内最低调用次数,时间窗�?�内,至少调用的次数.在时间窗�?�内总共都�?足10,认为�?需�?调控.
     */
    private long    leastWindowCount                 = 10L;

    /**
     * 当�?机器是平�?�异常率的多少�?�?�?级.如果�?个ip的异常率是该�?务所有ip的平�?�异常率到该比例时则会被判定为异常
     */
