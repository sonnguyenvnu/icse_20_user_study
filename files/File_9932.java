...
public class ArticleMgmtService {
    ...
    public synchronized void updateArticle(final JSONObject requestJSONObject) throws ServiceException {
        ...
        try {
            ...
            articleToUpdate.put(Article.ARTICLE_AUDIO_URL, ""); // �?薇语音预览更新 https://github.com/b3log/symphony/issues/791
    ...
    public void updateArticleByAdmin(final String articleId, final JSONObject article) {
        ...
        try {
            ...
            article.put(Article.ARTICLE_AUDIO_URL, ""); // �?薇语音预览更新 https://github.com/b3log/symphony/issues/791
