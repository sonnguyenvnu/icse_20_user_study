...
public class BridgeUtil {
	...
	final static String YY_RETURN_DATA = YY_OVERRIDE_SCHEMA + "return/";//格�?为   yy://return/{function}/returncontent
	...
	// 例�? javascript:WebViewJavascriptBridge._fetchQueue(); --> _fetchQueue
	...
	/**
	 * 这里�?�是加载lib包中assets中的 WebViewJavascriptBridge.js
	 * @param view webview
	 * @param path 路径
	 */
