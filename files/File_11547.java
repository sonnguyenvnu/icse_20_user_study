...
public class BaiduBaikePageProcessor implements PageProcessor {
    ...
    public static void main(String[] args) {
        ...
        ResultItems resultItems = spider.<ResultItems>get(String.format(urlTemplate, "æ°´åŠ›å?‘ç”µ"));
        System.out.println(resultItems);

        //multidownload
        List<String> list = new ArrayList<String>();
        list.add(String.format(urlTemplate,"é£ŽåŠ›å?‘ç”µ"));
        list.add(String.format(urlTemplate,"å¤ªé˜³èƒ½"));
        list.add(String.format(urlTemplate,"åœ°çƒ­å?‘ç”µ"));
        list.add(String.format(urlTemplate,"åœ°çƒ­å?‘ç”µ"));
