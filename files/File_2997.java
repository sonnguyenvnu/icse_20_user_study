...
/**
 * ç”±bufferã€?stackå’Œarcç»„æˆ?çš„çŠ¶æ€?
 */
public class State implements Cloneable
{
     ...
     * Joakim Nivre and Daniel FernÃƒÂ¡ndez-GonzÃƒÂ¡lez. "Arc-Eager Parsing with the Tree Constraint."
    ...
    /**
     * @param sentenceSize å?¥å­?é•¿åº¦ï¼ˆä¸?åŒ…å?«ROOTï¼‰
     * @param rootFirst    æ˜¯å?¦å°†ROOTä½œä¸ºindex=0çš„è¯?è¯­ï¼Œå?¦åˆ™ä½œä¸ºæœ€å?Žä¸€ä¸ªè¯?è¯­
     */
