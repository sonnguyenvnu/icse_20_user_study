...
/**
 * �?应消�?�,controller中处�?��?�，返回此对象，�?应请求结果给客户端。
 *
 * @since 2.0
 */
@ApiModel(description = "�?应结果")
public class ResponseMessage<T> implements Serializable {
    ...
    @ApiModelProperty("调用结果消�?�")
    public String getMessage() {
        return message;
    }

    @ApiModelProperty(value = "状�?�?", required = true)
    public int getStatus() {
        return status;
    }

    @ApiModelProperty("�?功时�?应数�?�")
    public T getResult() {
        return result;
    }
