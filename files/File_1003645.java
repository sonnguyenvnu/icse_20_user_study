...
public interface HandlerDecorator {
  ...
  /**
   * A factory for decorator impls that effectively inserts the given handler before the â€œrestâ€? of the handlers.
   * <p>
  ...
  /**
   * A factory for decorator impls that effectively inserts the given chain before the â€œrestâ€? of the handlers.
