...
public class RefundOrderServiceImpl extends BaseService4RefundOrder implements IRefundOrderService {
    ...
    public Map create(String jsonParam) {
        ...
        if (ObjectValidUtil.isInvalid(bizParamMap)) {
            _log.warn("æ–°å¢žé€€æ¬¾è®¢å?•å¤±è´¥, {}. jsonParam={}", RetEnum.RET_PARAM_NOT_FOUND.getMessage(), jsonParam);
        ...
        if(refundOrderObj == null) {
            _log.warn("æ–°å¢žé€€æ¬¾è®¢å?•å¤±è´¥, {}. jsonParam={}", RetEnum.RET_PARAM_INVALID.getMessage(), jsonParam);
    ...
    public Map select(String jsonParam) {
        ...
        Map<String, Object> bizParamMap = baseParam.getBizParamMap();
        if (ObjectValidUtil.isInvalid(bizParamMap)) {
            _log.warn("æ ¹æ?®é€€æ¬¾è®¢å?•å?·æŸ¥è¯¢é€€æ¬¾è®¢å?•å¤±è´¥, {}. jsonParam={}", RetEnum.RET_PARAM_NOT_FOUND.getMessage(), jsonParam);
            return RpcUtil.createFailResult(baseParam, RetEnum.RET_PARAM_NOT_FOUND);
        }
        ...
        if (ObjectValidUtil.isInvalid(refundOrderId)) {
            _log.warn("æ ¹æ?®é€€æ¬¾è®¢å?•å?·æŸ¥è¯¢é€€æ¬¾è®¢å?•å¤±è´¥, {}. jsonParam={}", RetEnum.RET_PARAM_INVALID.getMessage(), jsonParam);
            return RpcUtil.createFailResult(baseParam, RetEnum.RET_PARAM_INVALID);
        }
    ...
    public Map selectByMchIdAndRefundOrderId(String jsonParam) {
        ...
        Map<String, Object> bizParamMap = baseParam.getBizParamMap();
        if (ObjectValidUtil.isInvalid(bizParamMap)) {
            _log.warn("æ ¹æ?®å•†æˆ·å?·å’Œé€€æ¬¾è®¢å?•å?·æŸ¥è¯¢é€€æ¬¾è®¢å?•å¤±è´¥, {}. jsonParam={}", RetEnum.RET_PARAM_NOT_FOUND.getMessage(), jsonParam);
            return RpcUtil.createFailResult(baseParam, RetEnum.RET_PARAM_NOT_FOUND);
        }
        ...
        if (ObjectValidUtil.isInvalid(mchId, refundOrderId)) {
            _log.warn("æ ¹æ?®å•†æˆ·å?·å’Œé€€æ¬¾è®¢å?•å?·æŸ¥è¯¢é€€æ¬¾è®¢å?•å¤±è´¥, {}. jsonParam={}", RetEnum.RET_PARAM_INVALID.getMessage(), jsonParam);
            return RpcUtil.createFailResult(baseParam, RetEnum.RET_PARAM_INVALID);
        }
    ...
    public Map updateStatus4Ing(String jsonParam) {
        ...
        Map<String, Object> bizParamMap = baseParam.getBizParamMap();
        if (ObjectValidUtil.isInvalid(bizParamMap)) {
            _log.warn("ä¿®æ”¹é€€æ¬¾è®¢å?•çŠ¶æ€?å¤±è´¥, {}. jsonParam={}", RetEnum.RET_PARAM_NOT_FOUND.getMessage(), jsonParam);
            return RpcUtil.createFailResult(baseParam, RetEnum.RET_PARAM_NOT_FOUND);
        }
        String refundOrderId = baseParam.isNullValue("refundOrderId") ? null : bizParamMap.get("refundOrderId").toString();
        String channelOrderNo = baseParam.isNullValue("channelOrderNo") ? null : bizParamMap.get("channelOrderNo").toString();
        if (ObjectValidUtil.isInvalid(refundOrderId)) {
            _log.warn("ä¿®æ”¹é€€æ¬¾è®¢å?•çŠ¶æ€?å¤±è´¥, {}. jsonParam={}", RetEnum.RET_PARAM_INVALID.getMessage(), jsonParam);
            return RpcUtil.createFailResult(baseParam, RetEnum.RET_PARAM_INVALID);
        }
    ...
    public Map sendRefundNotify(String jsonParam) {
        ...
        Map<String, Object> bizParamMap = baseParam.getBizParamMap();
        if (ObjectValidUtil.isInvalid(bizParamMap)) {
            _log.warn("å?‘é€?é€€æ¬¾è®¢å?•å¤„ç?†å¤±è´¥, {}. jsonParam={}", RetEnum.RET_PARAM_NOT_FOUND.getMessage(), jsonParam);
            return RpcUtil.createFailResult(baseParam, RetEnum.RET_PARAM_NOT_FOUND);
        }
        String msg = baseParam.isNullValue("msg") ? null : bizParamMap.get("msg").toString();
        if (ObjectValidUtil.isInvalid(msg)) {
            _log.warn("å?‘é€?é€€æ¬¾è®¢å?•å¤„ç?†å¤±è´¥, {}. jsonParam={}", RetEnum.RET_PARAM_INVALID.getMessage(), jsonParam);
            return RpcUtil.createFailResult(baseParam, RetEnum.RET_PARAM_INVALID);
        }
        int result = 1;
        try {
