...
public class StatisticRdbRepository {
     ...
     * 添加任务�?行结果统计数�?�.
     * 
     * @param taskResultStatistics 任务�?行结果统计数�?�对象
     * @return 添加�?作是�?��?功
     */
     ...
     * 添加�?行中的任务统计数�?�.
     * 
     * @param taskRunningStatistics �?行中的任务统计数�?�对象
     * @return 添加�?作是�?��?功
     */
     ...
     * 添加�?行中的作业统计数�?�.
     * 
     * @param jobRunningStatistics �?行中的作业统计数�?�对象
     * @return 添加�?作是�?��?功
     */
     ...
     * 添加作业注册统计数�?�.
     * 
     * @param jobRegisterStatistics 作业注册统计数�?�对象
     * @return 添加�?作是�?��?功
     */
