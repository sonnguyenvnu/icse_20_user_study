 ...
 */
@RestController
@Api(tags = "OAuth2.0-æœ?åŠ¡-æŽˆæ?ƒ", value = "OAuth2.0-æœ?åŠ¡-æŽˆæ?ƒ")
...
public class OAuth2AuthorizeController {
    ...
    @ApiOperation("èŽ·å?–å½“å‰?ç™»å½•ç”¨æˆ·OAuth2.0æŽˆæ?ƒç ?")
    @Authorize
    ...
    @ApiOperation(value = "implicitæ–¹å¼?ç”³è¯·token", tags = "OAuth2.0-æœ?åŠ¡-ç”³è¯·token")
    @ApiImplicitParam(paramType = "query",name =  OAuth2Constants.client_id,required = true)
