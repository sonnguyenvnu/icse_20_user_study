 ...
 * <p>
 * None of the methods of this interface are additive (i.e. calling {@link #handlers(Action)} twice will result in the second â€œvalueâ€? being used).
 * <p>
...
public interface RatpackServerSpec {
   ...
   * <p>
   * The given function receives the â€œbaseâ€? registry (i.e. the base infrastructure provided by Ratpack) as its argument.
   * <p>
