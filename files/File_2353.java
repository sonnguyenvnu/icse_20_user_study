...
public class MybatisGeneratorUtil {
	...
	/**
	 * æ ¹æ?®æ¨¡æ?¿ç”Ÿæˆ?generatorConfig.xmlæ–‡ä»¶
	 * @param jdbcDriver   é©±åŠ¨è·¯å¾„
	 * @param jdbcUrl      é“¾æŽ¥
	 * @param jdbcUsername å¸?å?·
	 * @param jdbcPassword å¯†ç ?
	 * @param module        é¡¹ç›®æ¨¡å?—
	 * @param database      æ•°æ?®åº“
	 * @param tablePrefix  è¡¨å‰?ç¼€
	...
	public static void generator(
		...
		System.out.println("========== å¼€å§‹ç”Ÿæˆ?generatorConfig.xmlæ–‡ä»¶ ==========");
		List<Map<String, Object>> tables = new ArrayList<>();
		try {
			VelocityContext context = new VelocityContext();
			Map<String, Object> table;

			// æŸ¥è¯¢å®šåˆ¶å‰?ç¼€é¡¹ç›®çš„æ‰€æœ‰è¡¨
		...
		System.out.println("========== ç»“æ?Ÿç”Ÿæˆ?generatorConfig.xmlæ–‡ä»¶ ==========");

		System.out.println("========== å¼€å§‹è¿?è¡ŒMybatisGenerator ==========");
		...
		System.out.println("========== ç»“æ?Ÿè¿?è¡ŒMybatisGenerator ==========");

		System.out.println("========== å¼€å§‹ç”Ÿæˆ?Service ==========");
		...
		System.out.println("========== ç»“æ?Ÿç”Ÿæˆ?Service ==========");
	}

	// é€’å½’åˆ é™¤é?žç©ºæ–‡ä»¶å¤¹
