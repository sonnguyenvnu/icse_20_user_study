    ...
    public R getField(String id){
        ...
        switch(oaExamineCategory.getType()){
            case 1:
                ...
                break;
            case 2:
                fieldUtil.oaFieldAdd("type_id", "请�?�类型", "select", new String[]{"年�?�", "事�?�", "病�?�", "产�?�", "调休", "婚�?�", "丧�?�", "其他"}, 1, 0, oaExamineInfo.get("type_id"), "", 3)
                        ...
                        .oaFieldAdd("end_time", "结�?�时间", "datetime", arr, 1, 0, oaExamineInfo.get("end_time"), "", 3)
            ...
            case 3:
                ...
                break;
            case 4:
                fieldUtil.oaFieldAdd("content", "加�?�原因", "text", arr, 1, 0, oaExamineInfo.get("content"), "", 3)
                        .oaFieldAdd("start_time", "开始时间", "datetime", arr, 1, 0, oaExamineInfo.get("start_time"), "", 3)
                        .oaFieldAdd("end_time", "结�?�时间", "datetime", arr, 1, 0, oaExamineInfo.get("end_time"), "", 3)
                        .oaFieldAdd("duration", "加�?�总天数", "floatnumber", arr, 1, 0, oaExamineInfo.get("duration"), "", 3)
                        .oaFieldAdd("remark", "备注", "textarea", arr, 0, 0, oaExamineInfo.get("remark"), "", 3);
                break;
            case 5:
                fieldUtil.oaFieldAdd("content", "差旅事由", "text", arr, 1, 0, oaExamineInfo.get("content"), "", 3)
                        ...
                        .oaFieldAdd("money", "报销总金�?", "floatnumber", arr, 1, 0, String.valueOf(oaExamineInfo.getInt("money")), "", 3)
                        .oaFieldAdd("remark", "备注", "textarea", arr, 0, 0, oaExamineInfo.get("remark"), "", 3);
                break;
            case 6:
                fieldUtil.oaFieldAdd("content", "借款事由", "text", arr, 1, 0, oaExamineInfo.get("content"), "", 3)
                        .oaFieldAdd("money", "借款金�?（元）", "floatnumber", arr, 1, 0, String.valueOf(oaExamineInfo.getInt("money")), "", 3)
                        .oaFieldAdd("remark", "备注", "textarea", arr, 0, 0, oaExamineInfo.get("remark"), "", 3);
                break;
            default:
