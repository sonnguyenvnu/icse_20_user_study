 ...
 * @see #onCreate
 * @see #setContentView
 * @use extends BaseTabActivity, 具体�?�考.DemoTabActivity
...
, OnClickListener, OnTabSelectedListener {
	...
	/**
	 * @param savedInstanceState
	 * @param layoutResID activity全局视图view的布局资�?id，默认值为R.layout.base_tab_activity
	 * @return
	 * @must 1.�?�?在�?类�?�?这个类中onCreate中的代�?;
	 *       2.在�?类onCreate中super.onCreate(savedInstanceState, layoutResID);
	 *       initView();initData();initEvent();
	 */
	 ...
	 * @return
	 * @must 1.�?�?在�?类�?�?这个类中onCreate中的代�?;
	 *       2.在�?类onCreate中super.onCreate(savedInstanceState, listener);
	 *       initView();initData();initEvent();
	 */
	...
	/**
	 * @param savedInstanceState
	 * @param layoutResID activity全局视图view的布局资�?id。 <= 0 ? R.layout.base_tab_activity : layoutResID
...
//	//BaseActivity�?写setContentView�?�这个方法一定会被调用，final有无都会导致崩溃，去掉throw Exception也会导致contentView为null而崩溃
//	//防止�?类中setContentView <<<<<<<<<<<<<<<<<<<<<<<<
//	/**
