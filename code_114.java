...
//bookkeeper/bookkeeper-server/src/main/java/org/apache/bookkeeper/metastore/InMemoryMetastoreTable.java
/**
...
public class InMemoryMetastoreTable implements MetastoreScannableTable {
    ...
    @Override
    public void _XXXXX_(final String key, final Value value, final Version version, final MetastoreCallback<Version> cb,
            final Object ctx) {
        scheduler.submit(new Runnable() {
            @Override
            public void run() {
