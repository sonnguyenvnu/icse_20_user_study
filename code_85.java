...
//bookkeeper/bookkeeper-server/src/main/java/org/apache/bookkeeper/client/BookKeeperAdmin.java
/**
 *
...
public class BookKeeperAdmin implements AutoCloseable {
    ...
    private static Map<BookieSocketAddress, BookieSocketAddress> _XXXXX_(
            List<BookieSocketAddress> ensemble,
            Map<Integer, BookieSocketAddress> targetBookieAddresses) {
