...
//eagle/eagle-core/eagle-metadata/eagle-metadata-base/src/main/java/org/apache/eagle/metadata/resource/DashboardResource.java
/*
...
public class DashboardResource {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @RolesAllowed({User.Role.USER, User.Role.ADMINISTRATOR})
    public RESTResponse<DashboardEntity> _XXXXX_(String uuid, @Auth User user) {
