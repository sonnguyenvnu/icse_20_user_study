...
//eagle/eagle-jpm/eagle-jpm-service/src/main/java/org/apache/eagle/service/jpm/MRJobExecutionResource.java
/*
...
public class MRJobExecutionResource {
    ...
    @Path("search")
    @Produces(MediaType.APPLICATION_JSON)
    public GenericServiceAPIResponseEntity _XXXXX_(@QueryParam("jobId") String jobId,
