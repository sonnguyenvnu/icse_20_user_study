...
//axis2-java/modules/transport/base/src/main/java/org/apache/axis2/transport/base/AbstractTransportListenerEx.java
/*
...
public abstract class AbstractTransportListenerEx<E extends ProtocolEndpoint>
    ...
    @Override
    protected final void _XXXXX_(AxisService service) throws AxisFault {
        E endpoint = createEndpoint();
