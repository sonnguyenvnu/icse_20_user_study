...
//eagle/eagle-core/eagle-alert-parent/eagle-alert/alert-coordinator/src/main/java/org/apache/eagle/alert/coordinator/provider/InMemScheduleConext.java
/*
...
public class InMemScheduleConext implements IScheduleContext {
    ...
    @Override
    public Map<String, StreamDefinition> _XXXXX_() {
        return schemas;
    }
