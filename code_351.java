...
//bookkeeper/stream/statelib/src/main/java/org/apache/bookkeeper/statelib/impl/rocksdb/checkpoint/dlog/DLCheckpointStore.java
/*
...
public class DLCheckpointStore implements CheckpointStore {
    ...
    @Override
    public InputStream _XXXXX_(String filePath) throws IOException {
        try {
