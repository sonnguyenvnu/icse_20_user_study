...
//bookkeeper/bookkeeper-server/src/main/java/org/apache/bookkeeper/verifier/DirectBookkeeperDriver.java
/**
 *
...
class DirectBookkeeperDriver implements BookkeeperVerifier.BookkeeperDriver {
    ...
    @Override
    public void _XXXXX_(long ledgerID, long entryID, byte[] data, Consumer<Integer> cb) {
        LedgerHandle handle;
