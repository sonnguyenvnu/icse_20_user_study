...
//eagle/eagle-core/eagle-metadata/eagle-metadata-jdbc/src/main/java/org/apache/eagle/metadata/store/jdbc/JDBCMetadataMetadataStoreServiceImpl.java
/*
...
public class JDBCMetadataMetadataStoreServiceImpl implements JDBCMetadataQueryService {
    ...
    @Override
    public <T, E extends Throwable> int _XXXXX_(String insertSql, Collection<T> entities, ThrowableConsumer2<PreparedStatement, T, E> mapper) throws E, SQLException {
        Connection connection = null;
        PreparedStatement statement = null;
        try {
            connection = dataSource.getConnection();
