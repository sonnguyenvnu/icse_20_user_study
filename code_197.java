...
//bookkeeper/stream/distributedlog/core/src/main/java/org/apache/distributedlog/impl/logsegment/BKLogSegmentEntryReader.java
/**
...
public class BKLogSegmentEntryReader implements SafeRunnable, LogSegmentEntryReader, AsyncCallback.OpenCallback {
    ...
    @Override
    public CompletableFuture<List<Entry.Reader>> _XXXXX_(int numEntries) {
